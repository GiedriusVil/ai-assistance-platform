...
*/
const MODULE_ID = 'aca-coach-datasource-provider-configuration';
...
const { COACH_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

  static NAME = 'coachDatasourceProvider';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: COACH_DATASOURCE_PROVIDER_SCHEMA,
    };
    return RET_VAL;
  }
