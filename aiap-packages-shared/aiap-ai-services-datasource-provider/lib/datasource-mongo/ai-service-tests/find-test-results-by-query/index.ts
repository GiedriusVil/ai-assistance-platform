...
*/
const MODULE_ID = 'aiap-ai-services-datasource-provider-datasource-mongo-ai-service-tests-find-test-results-by-query';
...
export const findTestResultsByQuery = async (
  ...
  try {
    ...
    const RET_VAL: IFindAiServiceTestsResultsByQueryResponseV1 = {
      items: RESULT,
    ...
    logger.error(findTestResultsByQuery.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
