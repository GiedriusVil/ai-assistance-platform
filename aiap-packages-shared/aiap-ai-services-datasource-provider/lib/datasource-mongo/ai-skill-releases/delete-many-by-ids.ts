...
*/
const MODULE_ID = 'aiap-ai-services-datasource-provider-datasource-mongo-ai-skill-releases-delete-many-by-ids';
...
export const deleteManyByIds = async (
  ...
  try {
    ...
    const RET_VAL: IDeleteAiSkillReleasesByIdsResponseV1 =
    {
      ids: ids,
      status: 'SUCCESS',
    };
