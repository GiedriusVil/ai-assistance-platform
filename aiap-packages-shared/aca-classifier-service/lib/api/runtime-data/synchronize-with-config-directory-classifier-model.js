...
*/
const MODULE_ID = 'aca-classifier-service-runtime-data-service-synchronize-with-config-directory-classifier-model';
...
const synchronizeWithConfigDirectoryClassifierModel = async (context, params) => {
  ...
  try {
    ...
    if (
      ...
      fsExtra.writeFileSync(
        `${DIR_CLASSIFIER_MODELS}/${params?.value?.id}.json`,
    ...
    logger.error(synchronizeWithConfigDirectoryClassifierModel.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
