...
*/
const MODULE_ID = 'aca-rules-datasource-provider-v2-configuration';
...
const { RULES_DATASOURCE_PROVIDER_V2_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

  static NAME = 'rulesDatasourceProviderV2';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: RULES_DATASOURCE_PROVIDER_V2_SCHEMA,
    };
    return RET_VAL;
  }
