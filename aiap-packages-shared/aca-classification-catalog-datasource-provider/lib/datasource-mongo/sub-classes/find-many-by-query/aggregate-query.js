  ...
  const RET_VAL = {
    $match: {
      $and: [
        ...
        matchFieldByExactValue('segmentId', FILTER, FILTER_OPTIONS),
        matchFieldByExactValue('familyId', FILTER, FILTER_OPTIONS),
        matchFieldByExactValue('classId', FILTER, FILTER_OPTIONS),
        {
          $or: [
