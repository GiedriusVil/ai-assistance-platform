...
*/
const MODULE_ID = 'aca-auditor-express-routes-controller-rules-messages-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    if (lodash.isEmpty(ERRORS)) {
      result = await messagesAuditorService.findManyByQuery(CONTEXT, PARAMS);
    }
  } catch (error) {
