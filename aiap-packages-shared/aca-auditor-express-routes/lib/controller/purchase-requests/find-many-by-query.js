...
*/
const MODULE_ID = 'aca-auditor-express-routes-controller-purchase-requests-find-many-by-query';
...
const { purchaseRequestsAuditorService } = require('@ibm-aca/aca-auditor-service');
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    if (lodash.isEmpty(ERRORS)) {
      result = await purchaseRequestsAuditorService.findManyByQuery(CONTEXT, PARAMS);
    }
  } catch (error) {
