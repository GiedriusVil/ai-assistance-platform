...
*/
const MODULE_ID = 'tenant-event-stream-handler-live-analytics-filters-index';
...
export const subscribe = async (
  ...
  try {
    ...
    await EVENT_STREAM.subscribe(AIAP_EVENT_TYPE.SAVE_LIVE_ANALYTICS_FILTER, FilterSaveEventHandler(TENANT));
    await EVENT_STREAM.subscribe(AIAP_EVENT_TYPE.DELETE_LIVE_ANALYTICS_FILTER, FilterDeleteEventHandler(TENANT));
  } catch (error) {
