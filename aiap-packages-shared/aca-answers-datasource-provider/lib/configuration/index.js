...
*/
const MODULE_ID = 'answers-datasource-provider-configuration';
...
const { ANSWERS_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'answersDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: ANSWERS_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
