...
*/
const MODULE_ID = 'aca-notifications-express-routes-index';
...
const { notificationsRoutes } = require('./lib/routes');
...
const initByConfigurationProvider = async (configurationProvider, app) => {
  try {
    ...
    app.use('/api/notifications', authByJWTBearerStrategy({ session: false }), notificationsRoutes);
