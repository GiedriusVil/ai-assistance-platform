...
*/
const MODULE_ID = 'policy-engine-client-create-engine';
...
const createEngineInstance = async (orgId) => {
    let configuration;
    let requestUrl;
    let requestOptions;
    ...
    try {
        ...
        requestUrl = ramda.path(['policyEngineAPI', 'client', 'url'], configuration) + '/create';
        if (
        ...
        logger.error('createEngineInstance', { ACA_ERROR });
        throw ACA_ERROR;
    }
}
