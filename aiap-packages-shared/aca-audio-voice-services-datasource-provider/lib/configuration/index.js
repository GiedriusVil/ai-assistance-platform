...
*/
const MODULE_ID = 'aca-audio-voice-services-datasource-provider-configuration';
...
const { AUDIO_VOICE_SERVICES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'audioVoiceServicesDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: AUDIO_VOICE_SERVICES_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
