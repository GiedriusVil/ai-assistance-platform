...
*/
const MODULE_ID = 'aca-rules-express-routes-controller-rules-messages-save-one'
...
const saveOne = async (request, response) => {
  ...
  const CONTEXT_USER_ID = ramda.path([], CONTEXT);
  ...
  try {
    ...
    result = await rulesMessagesService.saveOne(CONTEXT, PARAMS);
  } catch (error) {
