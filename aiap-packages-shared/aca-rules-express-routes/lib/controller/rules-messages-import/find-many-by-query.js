...
*/
const MODULE_ID = 'aca-rules-express-routes-controller-rules-messages-import-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await rulesMessagesImportService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
