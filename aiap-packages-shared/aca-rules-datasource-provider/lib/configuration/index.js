...
*/
const MODULE_ID = 'aca-rules-datasource-provider-configurator';
...
const { RULES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'acaRulesDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: RULES_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
