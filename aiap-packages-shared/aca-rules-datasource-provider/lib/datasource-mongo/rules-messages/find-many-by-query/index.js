...
*/
const MODULE_ID = 'aca-rules-datasource-mongo-messages-find-many-by-query';
...
const findManyByQuery = async (datasource, context, params) => {
  ...
  try {
    ...
    const MESSAGES = ramda.pathOr([], ['items'], RESULT);
    const TOTAL = ramda.pathOr(MESSAGES.length, ['total'], RESULT);
