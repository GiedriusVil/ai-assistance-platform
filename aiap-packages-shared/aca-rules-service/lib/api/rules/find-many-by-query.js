...
*/
const MODULE_ID = 'aca-rules-service-rules-find-many-by-query';
...
const _findManyByQuery = async (context, params) => {
  ...
  const DATASOURCE_RESULT = await DATASOURCE.rules.findManyByQuery(context, params);
  ...
  for (let rule of DATASOURCE_ITEMS) {
    ...
    DATASOURCE.rules.saveOne(context, updateRuleParams);
  }
