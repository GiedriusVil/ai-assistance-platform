...
const MODULE_ID = 'aca-notifications-service-configurator';
...
const { NOTIFICATIONS_SERVICE_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer')

class Configurator {

    static NAME = 'notificationsService';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: NOTIFICATIONS_SERVICE_SCHEMA,
        };
        return RET_VAL;
    }
