...
*/
const MODULE_ID = 'aca-live-analytics-datasource-provider-queries-models-changes-find-many-by-query';
...
const findManyByQuery = async (datasource, context, params) => {
    ...
    const COLLECTION = datasource._collections.queriesChanges;
