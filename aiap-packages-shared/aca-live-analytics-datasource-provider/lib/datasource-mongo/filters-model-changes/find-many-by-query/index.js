...
*/
const MODULE_ID = 'aca-live-analytics-datasource-provider-filter-models-changes-find-many-by-query';
...
const findManyByQuery = async (datasource, context, params) => {
    ...
    const COLLECTION = datasource._collections.filtersChanges;
