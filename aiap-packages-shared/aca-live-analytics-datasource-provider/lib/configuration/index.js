...
*/
const MODULE_ID = 'aca-live-analytics-datasource-provider-configuration';
...
const { LIVE_ANALYTICS_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

  static NAME = 'liveAnalyticsDatasourceProvider';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: LIVE_ANALYTICS_DATASOURCE_PROVIDER_SCHEMA,
    };
    return RET_VAL;
  }
