...
*/
const MODULE_ID = 'aca-conversations-express-routes-controller-conversations-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await conversationsService.deleteManyByIds(context, params);
  } catch (error) {
