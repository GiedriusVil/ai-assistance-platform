...
*/
const MODULE_ID = 'aiap-object-storage-datasource-mongo-files-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  const COLLECTION = datasource._collections.files;
  ...
  try {
    ...
    const RET_VAL: IFileDeleteManyByIdsResponseV1 = {
      ids: ids
    };
    return RET_VAL;
  } catch (error) {
