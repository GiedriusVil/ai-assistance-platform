...
const MODULE_ID = 'aca-validation-engagements-service-configurator';
...
const { ENGAGEMENTS_SERVICE_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer')

class Configurator {

  static NAME = 'validationEngagementsService';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: ENGAGEMENTS_SERVICE_SCHEMA,
    };
    return RET_VAL;
  }
