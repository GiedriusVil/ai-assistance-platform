...
*/
const MODULE_ID = 'ai-translation-services-datasource-provider-configuration';
...
const setConfigurationProvider = (provider: any) => {
...
class Configurator {
  static NAME = 'aiTranslationServicesDatasourceProvider';
  ...
  static async loadConfiguration(RET_VAL, rawConfiguration, provider) {
    ...
    RET_VAL[Configurator.NAME] = await Configurator.transformRawConfiguration(
      rawConfiguration,
      provider
    );
  }
