...
*/
const MODULE_ID = 'aiap-ai-translation-services-datasource-mongo-ai-translation-models-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  try {
    ...
    const RET_VAL: IAiTranslationModelsDeleteManyByIdsResponseV1 = {
      status: 'SUCCESS'
    };
    return RET_VAL;
  } catch (error) {
