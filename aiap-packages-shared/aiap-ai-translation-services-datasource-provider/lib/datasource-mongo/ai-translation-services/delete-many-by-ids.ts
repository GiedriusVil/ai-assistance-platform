...
*/
const MODULE_ID = 'aiap-ai-translation-services-datasource-mongo-ai-translation-services-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  try {
    ...
    const RET_VAL: IAiTranslationServicesDeleteManyByIdsResponseV1 = {
      ids: IDS,
      status: 'SUCCESS'
    };
