...
*/
const MODULE_ID = 'ai-translation-services-datasource-mongo-ai-translation-prompts-find-one-by-query';
...
const findOneByQuery = async (
  ...
  try {
    ...
    const AI_TRANSLATION_PROMPT = ramda.pathOr({}, ['items', '0'], RESULT);
    
    const RET_VAL: IAiTranslationPromptsFindOneByQueryResponseV1 = formatResponse(AI_TRANSLATION_PROMPT);
    return RET_VAL;
  } catch (error) {
