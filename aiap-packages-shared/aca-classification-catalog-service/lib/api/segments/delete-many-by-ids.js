...
*/
const MODULE_ID = 'aca-classification-catalog-service-segments-delete-many-by-ids';
...
const deleteManyByIds = async (context, params) => {
    ...
    try {
        ...
        const RET_VAL = await DATASOURCE.segments.deleteManyByIds(context, params);
        ...
        if (
            ...
            for (let id of PARAMS_IDS) {
                let action = {
                    ...
                    type: ACTION_TYPES.SEGMENT_DELETE,
                }
