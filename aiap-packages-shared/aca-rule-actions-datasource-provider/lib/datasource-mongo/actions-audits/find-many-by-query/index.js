...
*/
const MODULE_ID = 'aca-rule-actions-datasource-provider-datasource-mongo-actions-audits-find-many-by-query';
...
const findManyByQuery = async (datasource, context, params) => {
  ...
  const COLLECTION = datasource._collections.actionsAudits;
