...
*/
const MODULE_ID = 'aca-catalog-rules-datasource-mongo';
const logger = require('@ibm-aca/aca-common-logger')(MODULE_ID);

const ramda = require('@ibm-aca/aca-wrapper-ramda');
const lodash = require('@ibm-aca/aca-wrapper-lodash');

const { AcaCatalogRulesDatasource } = require('../datasource');
...
const _rulesCatalogs = require('./rules-catalogs');

class AcaCatalogRulesDatasourceMongo extends AcaCatalogRulesDatasource {
  ...
  get rulesCatalogs() {
    return {
      findManyByQuery: async (context, params) => {
        return _rulesCatalogs.findManyByQuery(this, context, params);
      },
      deleteManyByIds: async (context, params) => {
        return _rulesCatalogs.deleteManyByIds(this, context, params);
      },
      findOneById: async (context, params) => {
        return _rulesCatalogs.findOneById(this, context, params);
      },
      deleteManyByRuleId: async (context, params) => {
        return _rulesCatalogs.deleteManyByRuleId(this, context, params);
      },
      saveOne: async (context, params) => {
        return _rulesCatalogs.saveOne(this, context, params);
      },
    };
  }
...
module.exports = {
  AcaCatalogRulesDatasourceMongo,
};
