...
*/
const MODULE_ID = 'aca-catalog-rules-datasource-provider-configuration';
...
const { CATALOG_RULES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'catalogRulesDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: CATALOG_RULES_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
