...
*/
const MODULE_ID = 'aca-analytics-live-express-routes-controllers-dashboards-configurations-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await dashboardsConfigurationsService.findManyByQuery(context, params);
  } catch (error) {
