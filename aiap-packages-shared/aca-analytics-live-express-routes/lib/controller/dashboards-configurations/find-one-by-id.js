...
*/
const MODULE_ID = 'aca-analytics-live-express-routes-controllers-dashboards-configurations-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    result = await dashboardsConfigurationsService.findOneById(context, params);
  } catch (error) {
