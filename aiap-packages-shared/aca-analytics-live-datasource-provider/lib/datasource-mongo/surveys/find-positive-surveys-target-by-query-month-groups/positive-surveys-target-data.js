...
*/
const MODULE_ID = 'aca-analytics-live-datasource-mongo-surveys-positive-surveys-target-data';
...
const getPositiveSurveysTarget = (params) => {
  const RET_VAL = [];
  let startDate;
  let endDate;
  let options;
  try {
    ...
    const ACA_ERROR = formatIntoAcaError(MODULE_ID, error);
    logger.error(getPositiveSurveysTarget.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}

module.exports = {
  getPositiveSurveysTarget,
}
