...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-surveys-find-positive-survey-by-query-month-groups';
...
const findPositiveSurveysByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    const FORMATTED_RESPONSE = formatResponse(RET_VAL);
