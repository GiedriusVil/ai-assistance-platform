...
*/
const MODULE_ID = 'aca-analytics-live-datasource-mongo-feedbacks-positive-feedbacks-target-data';
...
const getPositiveFeedbackTarget = (params) => {
  const RET_VAL = [];
  let startDate;
  let endDate;
  let options;
  try {
    ...
    const ACA_ERROR = formatIntoAcaError(MODULE_ID, error);
    logger.error(getPositiveFeedbackTarget.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}

module.exports = {
  getPositiveFeedbackTarget,
}
