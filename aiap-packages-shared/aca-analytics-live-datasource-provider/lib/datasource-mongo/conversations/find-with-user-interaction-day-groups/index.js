...
const findWithUserInteractionDayGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(findWithUserInteractionDayGroups.name, { pipeline });
    ...
    logger.error(findWithUserInteractionDayGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
