...
const findByQueryHourGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(findByQueryHourGroups.name, { query });
    ...
    logger.error(findByQueryHourGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
