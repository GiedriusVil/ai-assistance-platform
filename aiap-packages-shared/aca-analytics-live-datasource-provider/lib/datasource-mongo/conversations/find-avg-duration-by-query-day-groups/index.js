...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-conversations-find-avg-duration-by-query-day-groups';
...
const findAvgDurationByQueryDayGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(findAvgDurationByQueryDayGroups.name, { query });
