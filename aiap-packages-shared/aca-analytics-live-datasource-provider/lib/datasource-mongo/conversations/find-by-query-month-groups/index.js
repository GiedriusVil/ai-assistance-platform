...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-conversations-find-month-groups-by-query';
...
const findByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(findByQueryMonthGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
