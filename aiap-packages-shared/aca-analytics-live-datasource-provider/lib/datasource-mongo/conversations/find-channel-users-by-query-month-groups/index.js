...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-conversations-find-channel-users-by-query-month-groups';
...
const findChannelUsersByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(findChannelUsersByQueryMonthGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
