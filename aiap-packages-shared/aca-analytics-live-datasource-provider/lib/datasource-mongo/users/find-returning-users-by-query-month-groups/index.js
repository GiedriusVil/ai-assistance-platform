...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-users-find-returning-users-by-query-month-groups';
...
const findReturningUsersByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(findReturningUsersByQueryMonthGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
