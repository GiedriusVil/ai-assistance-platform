...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-users-find-usage-by-country-by-query-month-groups';
...
const findUsageByCountryByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(findUsageByCountryByQueryMonthGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
