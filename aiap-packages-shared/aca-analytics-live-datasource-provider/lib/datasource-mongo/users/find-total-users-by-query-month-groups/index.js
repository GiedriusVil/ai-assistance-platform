...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-users-find-total-users-by-query-month-groups';
...
const findTotalUsersByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(findTotalUsersByQueryMonthGroups.name, { pipeline });
    ...
    logger.error(findTotalUsersByQueryMonthGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
