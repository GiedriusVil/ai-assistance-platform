...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-entities-find-error-message-by-query-month-groups';
...
const findErrorMessageByQueryMonthGroups = async (datasource, context, params) => {
