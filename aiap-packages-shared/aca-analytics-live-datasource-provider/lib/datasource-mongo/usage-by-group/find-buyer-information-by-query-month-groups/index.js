...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-entities-find-buyer-information-by-query-month-groups';
...
const findBuyerInformationByQueryMonthGroups = async (datasource, context, params) => {
