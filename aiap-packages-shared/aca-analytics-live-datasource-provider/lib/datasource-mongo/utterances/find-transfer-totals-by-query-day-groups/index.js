...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-utterances-find-transfer-totals-by-query-day-groups';
...
const findTransferTotalsByQueryDayGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(findTransferTotalsByQueryDayGroups.name, { query });
    ...
    logger.error(findTransferTotalsByQueryDayGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
