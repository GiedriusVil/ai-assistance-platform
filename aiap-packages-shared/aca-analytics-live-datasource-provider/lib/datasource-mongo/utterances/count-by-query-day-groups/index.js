...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-utterances-count-by-query-day-groups';
...
const countByQueryDayGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(countByQueryDayGroups.name, { query });
    ...
    logger.error(countByQueryDayGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
