...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-utterances-count-by-query-hour-groups';
...
const countByQueryHourGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.info(countByQueryHourGroups.name, { query });
    ...
    logger.error(countByQueryHourGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
