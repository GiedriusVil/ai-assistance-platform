...
*/
const MODULE_ID = 'aca-analytics-live-datasource-provider-utterances-find-tickets-by-query-month-groups';
...
const findTicketsByQueryMonthGroups = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(findTicketsByQueryMonthGroups.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
