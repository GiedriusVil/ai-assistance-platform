...
*/
const MODULE_ID = 'aca-data-masking-datasource-provider-configuration';
...
const { DATA_MASKING_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

  static NAME = 'dataMaskingDatasourceProvider';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: DATA_MASKING_DATASOURCE_PROVIDER_SCHEMA,
    };
    return RET_VAL;
  }
