...
*/
const MODULE_ID = 'aca-data-masking-datasource-mongo';
...
const { AcaDataMaskingDatasource } = require('../datasource');
const { sanitizedCollectionsFromConfiguration } = require('./collections.utils');

const _dataMaskingConfigurations = require('./data-masking-configurations');

class AcaDataMaskingDatasourceMongo extends AcaDataMaskingDatasource {
  ...
  get dataMaskingConfigurations() {
    const RET_VAL = {
      findManyByQuery: async (context, params) => {
        return _dataMaskingConfigurations.findManyByQuery(this, context, params);
      },
      deleteManyByKeys: async (context, params) => {
        return _dataMaskingConfigurations.deleteManyByKeys(this, context, params);
      },
      findOneByKey: async (context, params) => {
        return _dataMaskingConfigurations.findOneByKey(this, context, params);
      },
      saveOne: async (context, params) => {
        return _dataMaskingConfigurations.saveOne(this, context, params);
      },
    };
    return RET_VAL;
  }
