...
*/
const MODULE_ID = 'aca-live-analytics-express-routes-dashboards-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    result = await liveAnalyticsDashboardsService.deleteManyByIds(context, params);
  } catch (error) {
