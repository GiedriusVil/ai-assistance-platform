...
*/
const MODULE_ID = 'aca-live-analytics-express-routes-dashboards-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    if (lodash.isEmpty(ERRORS)) {
      result = await liveAnalyticsDashboardsService.findManyByQuery(context, params);
    }
  } catch (error) {
