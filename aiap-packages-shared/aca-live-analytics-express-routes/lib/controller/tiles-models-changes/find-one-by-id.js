...
*/
const MODULE_ID = 'aca-live-analytics-express-routes-controller-tiles-models-changes-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    const PARAMS = { id: ID };
    result = await liveAnalyticsTilesChangesService.findOneById(CONTEXT, PARAMS);
  } catch (error) {
