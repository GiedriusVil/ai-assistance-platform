...
*/
const MODULE_ID = 'aca-live-analytics-express-routes-controller-dashboards-models-changes-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    retVal = await liveAnalyticsDashboardsChangesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
