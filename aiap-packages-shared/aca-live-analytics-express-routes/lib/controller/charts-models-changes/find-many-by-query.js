...
*/
const MODULE_ID = 'aca-live-analytics-express-routes-controller-charts-models-changes-find-many-by-query';
...
const { liveAnalyticsChartsChangesService } = require('@ibm-aca/aca-live-analytics-charts-service');
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    retVal = await liveAnalyticsChartsChangesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
