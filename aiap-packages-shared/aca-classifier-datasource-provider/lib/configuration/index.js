...
*/
const MODULE_ID = 'aca-classifier-datasource-provider-configuration';
...
const { CLASSIFIER_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'classifierDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: CLASSIFIER_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
