...
*/
const MODULE_ID = 'aiap-ai-service-express-routes-ai-services-import-many-from-file';
...
export const importManyFromFile = async (
  ...
  try {
    ...
    result = await aiServicesService.importMany(CONTEXT, PARAMS);
  } catch (error) {
    const ACA_ERROR = formatIntoAcaError(MODULE_ID, error);
    appendDataToError(ACA_ERROR, { CONTEXT_USER_ID, FILE });
