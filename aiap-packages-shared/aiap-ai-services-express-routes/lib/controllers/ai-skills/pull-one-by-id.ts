...
*/
const MODULE_ID = 'aiap-ai-services-express-routes-ai-skills-pull-one-by-id';
...
export const pullOneById = async (
  ...
  try {
    ...
    const PARAMS = {
      ...
      aiSkillId: request?.body?.id,
    };

    result = await aiSkillsService.pullOneById(CONTEXT, PARAMS);
  } catch (error) {
