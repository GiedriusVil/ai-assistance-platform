...
*/
const MODULE_ID = 'aiap-ai-service-express-routes-ai-service-tests-find-classification-report-by-id';
...
export const findClassificationReportsByQuery = async (
  ...
  try {
    ...
    result = await aiServiceTestsService.findClassificationReportsByQuery(CONTEXT, PARAMS);
  } catch (error) {
