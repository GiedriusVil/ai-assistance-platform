...
*/
const MODULE_ID = 'aiap-ai-service-express-routes-ai-service-tests-find-test-results-by-id';
...
export const findTestResultsById = async (
  ...
  try {
    ...
    result = await aiServiceTestsService.findTestResultsByQuery(CONTEXT, PARAMS);
