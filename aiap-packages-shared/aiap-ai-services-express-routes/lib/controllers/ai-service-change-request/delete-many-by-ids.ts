...
*/
const MODULE_ID = 'aiap-ai-service-express-routes-ai-services-change-request-delete-many-by-ids';
...
export const deleteManyByIds = async (
  ...
  try {
    ...
    result = await aiServicesChangeRequestService.deleteManyByIds(CONTEXT, PARAMS);
  } catch (error) {
