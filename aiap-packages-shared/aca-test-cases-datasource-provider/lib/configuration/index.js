...
*/
const MODULE_ID = 'aca-test-cases-datasource-provider-configuration';
...
const { TEST_CASES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'testCasesDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: TEST_CASES_DATASOURCE_PROVIDER_SCHEMA,
        };
    ...
    static async loadConfiguration(RET_VAL, rawConfiguration, provider) {
        if (
            ...
            const MESSAGE = `Missing required transformer object!`;
            throwAcaError(MODULE_ID, ACA_ERROR_TYPE.VALIDATION_ERROR, MESSAGE);
        }
