...
*/
const MODULE_ID = 'aca-data-masking-provider-configurator';
...
const setConfigurationProvider = (provider) => {
  if (ramda.isNil(provider)) {
    const MESSAGE = `configuration provider is missing! [aca-custom-config]`;
...
class Configurator {
  ...
  static NAME = 'dataMaskingProvider';
