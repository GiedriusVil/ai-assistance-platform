...
*/
const MODULE_ID = 'aca-test-cases-express-routes-controller-test-workers-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await testWorkersService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
