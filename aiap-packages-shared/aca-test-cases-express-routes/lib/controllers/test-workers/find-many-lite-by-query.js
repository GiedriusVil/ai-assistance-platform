...
*/
const MODULE_ID = 'aca-test-cases-express-routes-controller-test-workers-find-many-lite-by-query';
...
const findManyLiteByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await testWorkersService.findManyLiteByQuery(CONTEXT, PARAMS);
  } catch (error) {
