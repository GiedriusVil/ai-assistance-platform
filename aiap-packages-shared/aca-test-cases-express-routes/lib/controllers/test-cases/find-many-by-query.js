...
*/
const MODULE_ID = 'aca-test-cases-express-routes-controller-test-cases-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    const CONTEXT_USER_ACCESS_GROUP = ramda.path(['accessGroup'], CONTEXT_USER_SESSION);
    ...
    result = await testCasesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
