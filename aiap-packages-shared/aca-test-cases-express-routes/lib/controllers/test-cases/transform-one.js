...
*/
const MODULE_ID = 'aca-test-cases-express-routes-controller-test-cases-transform-one';
...
const transformOne = async (request, response) => {
  ...
  try {
    ...
    logger.info(transformOne.name, {
      params: PARAMS,
    });
    result = await testCasesService.transformOne({}, PARAMS);
  } catch (error) {
  ...
  if (lodash.isEmpty(ERRORS)) {
    ...
    logger.error(transformOne.name, { ERRORS });
