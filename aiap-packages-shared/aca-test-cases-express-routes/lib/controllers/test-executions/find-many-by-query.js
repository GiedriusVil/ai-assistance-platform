...
*/
const MODULE_ID = 'aca-test-cases-express-routes-controller-test-executions-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await testExecutionsService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
