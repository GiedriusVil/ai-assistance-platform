...
*/
const MODULE_ID = 'aca-test-cases-express-routes-controller-test-executions-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    result = await testExecutionsService.deleteManyByIds(CONTEXT, PARAMS);
  } catch (error) {
