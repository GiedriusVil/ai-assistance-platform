...
*/
const MODULE_ID = 'app-service-runtime-data-service-delete-many-by-ids-from-config-directory-application';
...
export const deleteManyByIdsFromConfigDirectoryApplication = async (
  context: IContextV1,
  params: {
    ids: Array<any>,
  },
  ...
  try {
      ...
      if (
        ...
        for (const TMP_ID of params.ids) {
          if (
            ...
            const FILE_PATH = `${configAbsolutePath}/runtime-data-local/portal/applications/${TMP_ID}.json`;
    ...
    logger.error(deleteManyByIdsFromConfigDirectoryApplication.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
