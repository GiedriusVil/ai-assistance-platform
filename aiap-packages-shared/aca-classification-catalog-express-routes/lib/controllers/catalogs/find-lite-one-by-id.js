...
*/
const MODULE_ID = 'aca-classification-catalog-express-routes-controllers-catalogs-find-lite-one-by-id';
...
const findLiteOneById = async (request, response) => {
  ...
  try {
    ...
    result = await catalogsService.findLiteOneById(context, params);
  } catch (error) {
