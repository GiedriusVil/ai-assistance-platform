...
*/
const MODULE_ID = 'aca-classification-catalog-express-routes-controllers-families-find-lite-one-by-id';
...
const findLiteOneById = async (request, response) => {
  ...
  try {
    ...
    result = await familiesService.findLiteOneById(context, params);
  } catch (error) {
