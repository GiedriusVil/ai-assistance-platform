...
*/
const MODULE_ID = 'aca-classification-catalog-express-controller-vectors-find-many-by-query';
...
const { constructActionContextFromRequest, constructDefaultFindManyQueryFromRequest } = require('@ibm-aiap/aiap-utils-express-routes');
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    retVal = await verctorsService.findManyByQuery(context, params);
  } catch (error) {
