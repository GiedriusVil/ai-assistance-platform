...
*/
const MODULE_ID = 'aca-classification-catalog-express-routes-controllers-sub-classes-find-lite-one-by-id';
...
const findLiteOneById = async (request, response) => {
  ...
  try {
    ...
    result = await subClassesService.findLiteOneById(context, params);
  } catch (error) {
