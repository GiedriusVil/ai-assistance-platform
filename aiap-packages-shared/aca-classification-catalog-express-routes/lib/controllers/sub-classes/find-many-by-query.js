...
*/
const MODULE_ID = 'aca-classification-catalog-express-controller-sub-classes-find-many-by-query';
  ...
  try {
    ...
    params = {
      filter: {
        ...
        classId: REQUEST_BODY?.filter?.classId,
      },
    ...
    retVal = await subClassesService.findManyByQuery(context, params);
  } catch (error) {
