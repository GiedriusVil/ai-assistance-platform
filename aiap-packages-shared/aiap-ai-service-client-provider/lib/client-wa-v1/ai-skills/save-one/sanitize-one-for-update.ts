...
*/
const MODULE_ID = 'aiap-ai-service-client-provider-client-wa-v1-ai-skills-save-one-sanitize-one-for-update';
...
export const sanitizeOneForUpdate = (
  ...
  try {
    ...
    // TODO -> LEGO -> Return to this next time
    // RET_VAL.append = true;
    return RET_VAL;
  } catch (error) {
    const ACA_ERROR = formatIntoAcaError(MODULE_ID, error);
    logger.error(sanitizeOneForUpdate.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
