...
*/
const MODULE_ID = 'aca-audio-voice-services-express-routes-audio-voice-services-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    result = await audioVoiceServicesService.deleteManyByIds(CONTEXT, IDS);
  } catch (error) {
