...
*/
const MODULE_ID = 'aca-audio-voice-services-express-routes-controller-audio-voice-services-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    if (lodash.isEmpty(ERRORS)) {
      result = await audioVoiceServicesService.findManyByQuery(CONTEXT, PARAMS);
    }
  } catch (error) {
