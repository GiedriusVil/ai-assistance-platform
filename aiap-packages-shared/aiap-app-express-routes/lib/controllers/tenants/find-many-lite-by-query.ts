...
*/
const MODULE_ID = 'app-express-routes-controllers-tenants-find-many-lite-by-query';
...
export const findManyLiteByQuery = async (
  ...
  try {
    ...
    const QUERY = request?.body || DEFAULT_QUERY;
    const PARAMS = {
      query: QUERY,
    };
    PARAMS.query.projections = {
      _id: 1,
      name: 1,
    };
  ...
  if (lodash.isEmpty(ERRORS)) {
    ...
    logger.error(findManyLiteByQuery.name, { ERRORS });
