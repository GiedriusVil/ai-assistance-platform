...
*/
const MODULE_ID = 'app-express-routes-controllers-tenants-import-many-from-file';
...
export const importManyFromFile = async (
  ...
  try {
    ...
    if (
      ...
      const ERROR_MESSAGE = 'Missing tenants file!';
    ...
    result = await tenantsService.importMany(CONTEXT, PARAMS);
  } catch (error) {
