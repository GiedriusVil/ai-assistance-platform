...
*/
const MODULE_ID = 'aiap-ai-translation-services-service-ai-translation-model-examples-find-one-by-id';
...
const findOneById = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.aiTranslationModelExamples.findOneById(context, params);
    return RET_VAL;
  } catch (error) {
