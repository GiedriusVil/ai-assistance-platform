...
*/
const MODULE_ID = 'aiap-ai-translation-services-service-ai-translation-prompts-find-one-by-id';
...
const findOneById = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.aiTranslationPrompts.findOneById(context, params);
    return RET_VAL;
  } catch (error) {
