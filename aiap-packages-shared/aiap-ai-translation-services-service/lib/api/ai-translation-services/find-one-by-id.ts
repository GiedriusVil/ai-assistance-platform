...
*/
const MODULE_ID = 'aiap-ai-translation-services-service-ai-translation-services-find-one-by-id';
...
const findOneById = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.aiTranslationServices.findOneById(context, params);
    return RET_VAL;
  } catch (error) {
