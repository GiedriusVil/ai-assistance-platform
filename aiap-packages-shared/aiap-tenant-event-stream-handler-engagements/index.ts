...
*/
const MODULE_ID = 'tenant-event-stream-handler-engagements-index';
...
export const subscribe = async (
  ...
  try {
    ...
    await EVENT_STREAM.subscribe(AIAP_EVENT_TYPE.SAVE_ENGAGEMENT, EngagementSaveEventHandler(TENANT));
  } catch (error) {
