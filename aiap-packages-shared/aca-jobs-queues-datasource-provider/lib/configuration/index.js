...
*/
const MODULE_ID = 'aca-jobs-queues-datasource-provider-configuration';
...
const { JOBS_QUEUES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'jobsQueuesDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: JOBS_QUEUES_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
