...
*/
const MODULE_ID = 'aca-ai-services-and-analysis-services-express-routes-controllers-ai-search-and-analysis-services-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await aiSearchAndAnalysisServicesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
