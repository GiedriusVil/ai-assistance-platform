...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-express-routes-controllers-ai-search-and-analysis-services-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    const PARAMS = { id: AI_SEARCH_AND_ANALYSIS_SERVICE_ID };
    result = await aiSearchAndAnalysisServicesService.findOneById(CONTEXT, PARAMS);
  } catch (error) {
