...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-express-routes-controllers-ai-search-and-analysis-projects-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await aiSearchAndAnalysisProjectsService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
