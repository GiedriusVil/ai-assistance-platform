...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-express-routes-controllers-ai-search-and-analysis-projects-import-many-from-file';
...
const importManyFromFile = async (request, response) => {
  ...
  try {
    ...
    result = await aiSearchAndAnalysisProjectsService.importMany(CONTEXT, PARAMS);
  } catch (error) {
