...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-express-routes-controllers-ai-search-and-analysis-projects-delete-many-by-service-model-ids';
...
const deleteManyByServiceProjectIds = async (request, response) => {
  ...
  try {
    ...
    const PARAMS = { ids: AI_SEARCH_AND_ANALYSIS_PROJECTS_IDS, aiSearchAndAnalysisServiceId: AI_SEARCH_AND_ANALYSIS_SERVICE_ID };
    result = await aiSearchAndAnalysisProjectsService.deleteManyByServiceIdAndProjectIds(CONTEXT, PARAMS);
  } catch (error) {
