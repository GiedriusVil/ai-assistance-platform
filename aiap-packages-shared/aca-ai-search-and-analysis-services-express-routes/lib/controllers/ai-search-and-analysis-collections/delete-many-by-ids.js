...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-express-routes-controllers-ai-search-and-analysis-collections-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    const PARAMS = { ids: AI_SEARCH_AND_ANALYSIS_COLLECTIONS_IDS };
    result = await aiSearchAndAnalysisCollectionsService.deleteManyByIds(CONTEXT, PARAMS);
  } catch (error) {
