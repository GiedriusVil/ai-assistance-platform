...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-express-routes-controllers-ai-search-and-analysis-collections-synchronize-many';
...
const synchronizeManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await aiSearchAndAnalysisCollectionsService.synchronizeManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
