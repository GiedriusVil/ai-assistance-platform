...
*/
const MODULE_ID = 'aca-data-masking-express-routes';
...
const initByConfigurationProvider = async (configurationProvider, app) => {
  try {
    ...
    app.use(
      '/api/v1/data-masking/import',
      authByJWTBearerStrategy({ session: false }),
      allowIfHasPagesPermissions('DataMaskingConfigurationViewV1'),
      routesImport
    );
    app.use(
      '/api/v1/data-masking/export',
