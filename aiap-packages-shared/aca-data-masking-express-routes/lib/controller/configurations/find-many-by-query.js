...
*/
const MODULE_ID = 'aca-data-masking-express-routes-controller-configurations-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await dataMaskingConfigurationsService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
