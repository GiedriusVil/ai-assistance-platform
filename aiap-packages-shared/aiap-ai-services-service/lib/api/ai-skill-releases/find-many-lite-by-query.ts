...
*/
const MODULE_ID = 'aiap-ai-services-service-ai-skill-releases-find-many-lite-by-query';
...
export const findManyLiteByQuery = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.aiSkillReleases.findManyLiteByQuery(context, params);
    return RET_VAL;
  } catch (error) {
