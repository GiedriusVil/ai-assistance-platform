...
*/
const MODULE_ID = 'aca-classifier-express-routes-controller-classifier-models-changes-find-many-by-query';
...
const { classifierModelsChangesService } = require('@ibm-aca/aca-classifier-service');
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    retVal = await classifierModelsChangesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
