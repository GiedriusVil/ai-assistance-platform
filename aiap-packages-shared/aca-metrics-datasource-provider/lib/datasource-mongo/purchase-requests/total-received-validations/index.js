...
*/
const MODULE_ID = 'aca-metrics-datasource-provider-purchase-requests-total-received-validations';
...
const totalReceivedValidations = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(`${totalReceivedValidations.name}`, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
