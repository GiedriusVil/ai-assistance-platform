...
*/
const MODULE_ID = 'aca-metrics-datasource-provider-purchase-requests-total-validated';
...
const totalValidatedPRs = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(`${totalValidatedPRs.name}`, { ACA_ERROR });
    throw error;
  }
}
