...
*/
const MODULE_ID = 'aca-metrics-datasource-provider-purchase-requests-total-completed-validations';
...
const totalCompletedValidations = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(totalCompletedValidations.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
