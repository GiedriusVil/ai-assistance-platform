...
*/
const MODULE_ID = 'aca-metrics-datasource-provider-purchase-requests-total-approved-validations';
...
const totalApprovedValidations = async (datasource, context, params) => {
  ...
  try {
    ...
    logger.error(`${totalApprovedValidations.name}`, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
