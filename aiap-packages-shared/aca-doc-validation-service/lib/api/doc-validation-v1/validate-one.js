...
*/
const MODULE_ID = 'aca-doc-validation-service-doc-validation-v1-validate-one';
...
const ERR_L_MODULE_MISSING = () =>
  throwAcaError(
    MODULE_ID,
    ACA_ERROR_TYPE.VALIDATION_ERROR,
    `Unable to retrieve ${MODULE_ID} L-module!`
  );
