...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-datasource-mongo-ai-search-and-analysis-collections-find-one-by-id';
...
const findOneById = async (datasource, context, params) => {
  ...
  const AI_SEARCH_AND_ANALYSIS_COLLECTION_ID = params?.id;
  ...
  try {
    ...
    filter = {
      _id: AI_SEARCH_AND_ANALYSIS_COLLECTION_ID
    };
