...
*/
const MODULE_ID = 'aca-ai-search-and-analysis-services-datasource-mongo-ai-search-and-analysis-services-find-one-by-id';
...
const findOneById = async (datasource, context, params) => {
  ...
  const AI_SEARCH_AND_ANALYSIS_SERVICE_ID = ramda.path(['id'], params);
  ...
  try {
    ...
    filter = {
      _id: AI_SEARCH_AND_ANALYSIS_SERVICE_ID
    };
    ...
    decryptAiSearchAndAnalysisServicePassword(datasource.configuration.encryptionKey, RET_VAL);
