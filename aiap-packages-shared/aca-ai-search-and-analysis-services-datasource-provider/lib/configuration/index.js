...
*/
const MODULE_ID = 'ai-search-and-analysis-services-datasource-provider-configuration';
...
const { AI_SEARCH_AND_ANALYSIS_SERVICES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

  static NAME = 'aiSearchAndAnalysisServicesDatasourceProvider';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: AI_SEARCH_AND_ANALYSIS_SERVICES_DATASOURCE_PROVIDER_SCHEMA,
    };
    return RET_VAL;
  }
