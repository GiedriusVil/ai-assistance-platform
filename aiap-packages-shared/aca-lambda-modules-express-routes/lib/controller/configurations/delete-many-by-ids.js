...
*/
const MODULE_ID = 'aca-lambda-modules-express-routes-controller-configurations-delete-one-by-id';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    result = await lambdaModulesConfigurationService.deleteManyByIds(context, params);
  } catch (error) {
