...
*/
const MODULE_ID = 'aca-lambda-modules-express-routes-controller-configurations-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    if (lodash.isEmpty(ERRORS)) {
      result = await lambdaModulesConfigurationService.findManyByQuery(CONTEXT, PARAMS);
    }
  } catch (error) {
