...
*/
const MODULE_ID = 'aca-validation-engagements-express-routes-controllers-validation-engagements-find-many-lite-by-query';
...
const findManyLiteByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await validationEngagementsService.findManyLiteByQuery(CONTEXT, PARAMS);
  } catch (error) {
