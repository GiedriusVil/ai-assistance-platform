...
*/
const MODULE_ID = 'aca-validation-engagements-express-routes-controller-validation-engagements-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    result = await validationEngagementsService.findOneById(CONTEXT, PARAMS);
  } catch (error) {
