...
*/
const MODULE_ID = 'aiap-ai-translation-services-express-routes-controllers-ai-translation-models-changes-find-many-by-query';
...
const findManyByQuery = async (
  ...
  try {
    ...
    result = await aiTranslationModelsChangesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
