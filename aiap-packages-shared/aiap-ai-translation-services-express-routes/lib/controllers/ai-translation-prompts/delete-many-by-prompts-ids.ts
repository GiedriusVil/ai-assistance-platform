...
*/
const MODULE_ID = 'aiap-ai-translation-service-express-routes-controllers-ai-translation-prompts-delete-many-by-service-prompts-ids';
...
const deleteManyByPromptsIds = async (
  ...
  try {
    ...
    const PARAMS = { ids: AI_TRANSLATION_PROMPTS_IDS, aiTranslationServiceId: AI_TRANSLATION_SERVICE_ID };
    result = await aiTranslationPromptsService.deleteManyByPromptsIds(CONTEXT, PARAMS);
  } catch (error) {
