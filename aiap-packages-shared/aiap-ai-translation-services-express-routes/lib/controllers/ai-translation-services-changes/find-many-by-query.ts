...
*/
const MODULE_ID = 'aiap-ai-translation-services-express-routes-controllers-ai-translation-services-changes-find-many-by-query';
...
const findManyByQuery = async (
  ...
  try {
    ...
    result = await aiTranslationServicesChangesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
