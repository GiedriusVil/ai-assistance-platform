...
*/
const MODULE_ID = 'aiap-ai-translation-service-express-routes-controllers-ai-translation-models-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  try {
    ...
    const PARAMS = { ids: AI_TRANSLATION_MODELS_IDS };
    result = await aiTranslationModelsService.deleteManyByIds(CONTEXT, PARAMS);
  } catch (error) {
