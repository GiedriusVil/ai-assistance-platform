...
*/
const MODULE_ID = 'aiap-ai-translation-services-express-routes-controllers-ai-translation-services-identify-language-by-id';
...
const identifyLanguageById = async (
  ...
  try {
    ...
    result = await aiTranslationModelsService.identifyLanguageById(CONTEXT, PARAMS);
  } catch (error) {
