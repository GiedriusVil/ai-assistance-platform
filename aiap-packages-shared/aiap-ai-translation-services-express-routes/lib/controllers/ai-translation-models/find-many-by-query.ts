...
*/
const MODULE_ID = 'aiap-ai-translation-service-express-routes-controllers-ai-translation-models-find-many-by-query';
...
const findManyByQuery = async (
  ...
  try {
    ...
    result = await aiTranslationModelsService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
