...
*/
const MODULE_ID = 'aca-engagements-cache-provider-configuration-index';
...
const { ENGAGEMENTS_STORE_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'acaEngagementsCacheProvider';

    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: ENGAGEMENTS_STORE_SCHEMA,
        };
        return RET_VAL;
    }
