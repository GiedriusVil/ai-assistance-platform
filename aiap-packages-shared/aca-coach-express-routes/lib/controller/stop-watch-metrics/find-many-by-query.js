...
*/
const MODULE_ID = 'aca-coach-express-routes-controller-stop-watch-metrics-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    if (lodash.isEmpty(ERRORS)) {
      result = await stopWatchMetricsService.findManyByQuery(CONTEXT, PARAMS);
    }
  } catch (error) {
