...
*/
const MODULE_ID = 'aiap-app-datasource-provider-configuration-index';
...
const setConfigurationProvider = (
  ...
  if (
    ...
    const ERROR_MESSAGE = `Missing required configuration provider! [aca-lite-config]`;
...
class Configurator {
  ...
  static NAME = 'appDatasourceProvider';
