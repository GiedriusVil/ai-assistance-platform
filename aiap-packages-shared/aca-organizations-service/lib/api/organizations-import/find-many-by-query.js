...
*/
const MODULE_ID = 'aca-organizations-service-organizations-import-find-many-by-query';
...
const _findManyByQuery = async (context, params) => {
  ...
  const RET_VAL = await DATASOURCE.organizationsImport.findManyByQuery(context, params);
  return RET_VAL;
}
