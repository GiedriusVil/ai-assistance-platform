...
*/
const MODULE_ID = 'aca-organizations-service-organizations-import-find-one-by-id';
...
const _findOneById = async (context, params) => {
  ...
  const RET_VAL = await DATASOURCE.organizationsImport.findOneById(context, params);
  return RET_VAL;
}
