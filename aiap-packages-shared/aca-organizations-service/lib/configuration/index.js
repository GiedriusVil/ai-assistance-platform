...
const MODULE_ID = 'aca-organizations-service-configurator';
...
const { ORGANIZATIONS_SERVICE_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer')

class Configurator {

  static NAME = 'organizationsService';
  ...
  static schema() {
    const RET_VAL = {
      [Configurator.NAME]: ORGANIZATIONS_SERVICE_SCHEMA,
    };
    return RET_VAL;
  }
