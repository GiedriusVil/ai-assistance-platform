...
*/
const MODULE_ID = 'aiap-object-storage-service-buckets-changes-find-many-by-query';
...
const findManyByQuery = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.bucketsChanges.findManyByQuery(context, params);
    return RET_VAL;
  } catch (error) {
