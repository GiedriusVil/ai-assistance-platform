...
*/
const MODULE_ID = 'aiap-object-storage-service-files-changes-find-many-by-query';
...
const findManyByQuery = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.filesChanges.findManyByQuery(context, params);
    return RET_VAL;
  } catch (error) {
