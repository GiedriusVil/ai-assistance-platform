...
*/
const MODULE_ID = 'aiap-object-storage-service-files-changes-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  try {
    ...
    const RET_VAL = await DATASOURCE.filesChanges.deleteManyByIds(context, params);
    return RET_VAL;
  } catch (error) {
