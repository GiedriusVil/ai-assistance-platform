...
*/
const MODULE_ID = 'aca-wrapper-http-exec-http-delete-request';

const got = require('got');
const { formatIntoAcaError, appendDataToError } = require('@ibm-aca/aca-utils-errors');
const { validateParams, appendQueryParamsToUrl } = require('./utils');

const execHttpDeleteRequest = async (context, params) => {
  ...
  try {
    ...
    logger.error(`${execHttpDeleteRequest.name}`, { ACA_ERROR });
    throw ACA_ERROR;
  }
};
