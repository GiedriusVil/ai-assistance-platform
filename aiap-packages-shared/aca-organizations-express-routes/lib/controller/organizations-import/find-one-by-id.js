...
*/
const MODULE_ID = 'aca-organizations-express-routes-controller-organizations-import-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    result = await organizationsImportService.findOneById(CONTEXT, PARAMS);
  } catch (error) {
