...
*/
const MODULE_ID = 'aca-organizations-express-routes-controller-organizations-find-many-by-query-lite';
...
const findManyLiteByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await organizationsService.findManyLiteByQuery(CONTEXT, PARAMS);
  } catch (error) {
