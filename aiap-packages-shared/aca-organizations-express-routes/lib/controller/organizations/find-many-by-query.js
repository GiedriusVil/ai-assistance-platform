...
*/
const MODULE_ID = 'aca-organizations-express-routes-controller-organizations-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await organizationsService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
