...
*/
const MODULE_ID = 'aiap-engagements-express-routes-controller-engagements-find-many-by-query';
...
export const findManyByQuery = async (
  ...
  try {
    ...
    result = await engagementsService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
