...
*/
const MODULE_ID = 'aca-object-storage-express-routes-controller-buckets-save-one'
...
const saveOne = async (request, response) => {
  ...
  let params: IBucketSaveOneParamsV1;
  ...
  try {
    ...
    result = await bucketsService.saveOne(context, params);
  } catch (error) {
