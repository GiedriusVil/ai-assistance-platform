...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-controller-buckets-find-many-by-query';
...
const findManyByQuery = async (
  ...
  let params: IBucketFindManyByQueryParamsV1;
  ...
  try {
    ...
    result = await bucketsService.findManyByQuery(context, params);
  } catch (error) {
