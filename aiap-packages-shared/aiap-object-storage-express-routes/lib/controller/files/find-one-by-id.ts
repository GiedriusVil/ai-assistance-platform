...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-controller-files-find-one-by-id';
...
const findOneById = async (
  ...
  let params: IFileFindOneByIdParamsV1;
  ...
  try {
    ...
    result = await filesService.findOneById(context, params);
  } catch (error) {
