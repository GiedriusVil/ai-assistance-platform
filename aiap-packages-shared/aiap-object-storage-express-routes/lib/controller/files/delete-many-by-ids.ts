...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-files-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  let params: IFileDeleteManyByIdsParamsV1;
  ...
  try {
    ...
    result = await filesService.deleteManyByIds(context, params);
  } catch (error) {
