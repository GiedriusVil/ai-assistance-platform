...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-controller-files-find-many-by-query';
...
const findManyByQuery = async (
  ...
  let params: IFileFindManyByQueryParamsV1;
  ...
  try {
    ...
    result = await filesService.findManyByQuery(context, params);
  } catch (error) {
