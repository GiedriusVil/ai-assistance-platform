...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-controller-buckets-changes-find-many-by-query';
...
const findManyByQuery = async (
  ...
  let params: IBucketChangesFindManyByQueryParamsV1;
  ...
  try {
    ...
    result = await bucketsChangesService.findManyByQuery(context, params);
  } catch (error) {
