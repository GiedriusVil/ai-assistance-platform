...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-controller-buckets-changes-find-one-by-id';
...
const findOneById = async (
  ...
  let params: IBucketChangesFindOneByIdParamsV1;
  ...
  try {
    ...
    result = await bucketsChangesService.findOneById(context, params);
  } catch (error) {
