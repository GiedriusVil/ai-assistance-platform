...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-buckets-changes-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  let params: IBucketChangesDeleteManyByIdsParamsV1;
  ...
  try {
    ...
    result = await bucketsChangesService.deleteManyByIds(context, params);
  } catch (error) {
