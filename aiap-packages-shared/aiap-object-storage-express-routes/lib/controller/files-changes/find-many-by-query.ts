...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-controller-files-changes-find-many-by-query';
...
const findManyByQuery = async (
  ...
  let params: IFileChangesFindManyByQueryParamsV1;
  ...
  try {
    ...
    result = await filesChangesService.findManyByQuery(context, params);
  } catch (error) {
