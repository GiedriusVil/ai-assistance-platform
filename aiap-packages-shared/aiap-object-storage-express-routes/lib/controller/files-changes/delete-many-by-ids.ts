...
*/
const MODULE_ID = 'aiap-object-storage-express-routes-files-changes-delete-many-by-ids';
...
const deleteManyByIds = async (
  ...
  let params: IFileChangesDeleteManyByIdsParamsV1;
  ...
  try {
    ...
    result = await filesChangesService.deleteManyByIds(context, params);
  } catch (error) {
