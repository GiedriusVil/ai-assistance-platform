...
*/
const MODULE_ID = 'aca-classification-rules-datasource-provider-configuration';
...
const { CLASSIFICATION_RULES_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'classificationRulesDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: CLASSIFICATION_RULES_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
