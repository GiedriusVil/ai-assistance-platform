...
*/
const MODULE_ID = 'aca-organizations-datasource-provider-configuration';
...
const { ORGANIZATIONS_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'acaOrganizationsDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: ORGANIZATIONS_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
