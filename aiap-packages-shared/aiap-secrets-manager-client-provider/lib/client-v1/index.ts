...
import { SecretManagerV1GetSecretParams, SecretManagerV1ListSecretsParams } from './types';

class AIAPIbmSecretsManagerClientV1 implements AIAPIbmSecretsManagerClient {
  ...
  async getSecret(context, params: SecretManagerV1GetSecretParams) {
    try {
  ...
  async listAllSecrets(context, params: SecretManagerV1ListSecretsParams) {
    try {
      const RET_VAL = await retryAsync(
...
export {
  AIAPIbmSecretsManagerClientV1,
  SecretManagerV1GetSecretParams,
  SecretManagerV1ListSecretsParams,
};
