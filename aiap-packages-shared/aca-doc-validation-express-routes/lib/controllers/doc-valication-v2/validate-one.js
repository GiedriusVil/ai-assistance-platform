...
*/
const MODULE_ID = `aca-doc-validation-express-routes-controllers-doc-validation-v2-validate-one`;
...
const validateOne = async (request, response) => {
  ...
  try {
    ...
    result = await docValidationV2Service.validateOne(context, params);
  } catch (error) {
