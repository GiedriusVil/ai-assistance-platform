...
*/
const MODULE_ID = `aca-doc-validation-express-routes-controllers-doc-validation-v1-validate-many`;
...
const validateMany = async (request, response) => {
  ...
  try {
    ...
    result = await docValidationV1Service.validateMany(context, { documents });
  } catch (error) {
