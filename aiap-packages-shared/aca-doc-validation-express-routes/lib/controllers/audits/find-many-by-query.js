...
*/
const MODULE_ID = 'aca-doc-validation-express-routes-controller-audits-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await docValidationAuditsService.findManyByQuery(context, params);
  } catch (error) {
