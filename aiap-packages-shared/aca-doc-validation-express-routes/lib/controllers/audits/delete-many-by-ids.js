...
*/
const MODULE_ID = 'aca-doc-validation-express-routes-controller-audits-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await docValidationAuditsService.deleteManyByIds(context, params);
  } catch (error) {
    const ACA_ERROR = formatIntoAcaError(MODULE_ID, error);
    appendDataToError(MODULE_ID, { contextUserId, params });
