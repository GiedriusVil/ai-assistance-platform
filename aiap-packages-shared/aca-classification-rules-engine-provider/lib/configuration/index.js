...
*/
const MODULE_ID = 'aca-classification-rules-engine-provider-configurator';
const lodash = require('@ibm-aca/aca-wrapper-lodash');

const { CLASSIFICATION_RULES_ENGINE_PROVIDER_SCHEMA } = require('./schema');
...
class Configurator {
    ...
    static NAME = 'acaClassificationRulesEngineProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: CLASSIFICATION_RULES_ENGINE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
