...
*/
const MODULE_ID = 'aca-topic-modeling-datasource-provider-configuration';
...
const { TOPIC_MODELING_DATASOURCE_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'topicModelingDatasourceProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: TOPIC_MODELING_DATASOURCE_PROVIDER_SCHEMA,
        };
        return RET_VAL;
    }
