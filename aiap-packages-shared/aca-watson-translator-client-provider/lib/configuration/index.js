...
*/
const MODULE_ID = 'aca-watson-translator-client-provider-configuration';
...
const { WA_TRANSLATOR_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'watsonTranslatorClientsProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: WA_TRANSLATOR_PROVIDER_SCHEMA,
        }
        return RET_VAL;
    }
