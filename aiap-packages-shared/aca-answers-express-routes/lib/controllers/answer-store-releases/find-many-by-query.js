...
*/
const MODULE_ID = 'aca-answers-express-routes-answer-store-releases-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    retVal = await answerStoreReleasesService.findManyByQuery(CONTEXT, PARAMS);
  } catch (error) {
