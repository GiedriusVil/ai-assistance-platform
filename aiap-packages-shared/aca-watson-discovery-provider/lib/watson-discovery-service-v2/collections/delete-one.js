...
*/
const MODULE_ID = 'aca-watson-discovery-provider-watson-discovery-service-v2-collections-delete-one';
...
const deleteOne = async (discoveryService, context, params) => {
  ...
  try {
    ...
    const RET_VAL = await discoveryService.deleteCollection(params);
    return RET_VAL;
  } catch (error) {
