...
*/
const MODULE_ID = 'aca-classification-rules-express-routes-controller-rules-audits-delete-many-by-ids';
...
const { rulesAuditsService } = require('@ibm-aca/aca-classification-rules-service');
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await rulesAuditsService.deleteManyByIds(context, params);
  } catch (error) {
