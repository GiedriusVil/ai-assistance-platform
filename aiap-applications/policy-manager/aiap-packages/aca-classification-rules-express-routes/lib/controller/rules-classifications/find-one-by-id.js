...
*/
const MODULE_ID = 'aca-classification-rules-express-routes-controller-classification-rules-classifications-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    result = await rulesClassificationsService.findOneById(context, params);
  } catch (error) {
