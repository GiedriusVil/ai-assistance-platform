...
*/
const MODULE_ID = 'aca-catalog-rules-express-routes-controller-rules-catalogs-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await rulesCatalogsService.deleteManyByIds(context, params);
  } catch (error) {
