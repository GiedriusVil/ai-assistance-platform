...
*/
const MODULE_ID = 'aca-catalog-rules-express-routes-controller-rules-catalogs-external-find-many-by-query';
...
const { rulesExternalCatalogsService } = require('@ibm-aca/aca-catalog-rules-service');
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await rulesExternalCatalogsService.findManyByQuery(context, params);
  } catch (error) {
