...
*/
const MODULE_ID = 'aca-catalog-rules-express-routes-controller-rules-conditions-delete-many-by-ids';
...
const { rulesConditionsService } = require('@ibm-aca/aca-catalog-rules-service');
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await rulesConditionsService.deleteManyByIds(context, params);
  } catch (error) {
