...
*/
const MODULE_ID = 'aca-rule-actions-express-routes-controller-rules-actions-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await ruleActionsService.findManyByQuery(context, params);
  } catch (error) {
