...
*/
const MODULE_ID = 'aca-rule-actions-express-routes-controller-rules-actions-delete-many-by-ids';
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await ruleActionsService.deleteManyByIds(context, params);
  } catch (error) {
