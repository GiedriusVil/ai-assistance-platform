...
*/
const MODULE_ID = 'aca-rule-actions-express-routes-controller-actions-audits-find-one-by-id';
...
const findOneById = async (request, response) => {
  ...
  try {
    ...
    params = { id };
    result = await ruleActionsAuditsService.findOneById(context, params);
  } catch (error) {
