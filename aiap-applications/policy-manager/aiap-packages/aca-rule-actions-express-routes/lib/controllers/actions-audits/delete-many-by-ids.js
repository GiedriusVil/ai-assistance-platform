...
*/
const MODULE_ID = 'aca-rule-actions-express-routes-controller-actions-audits-delete-many-by-ids';
...
const { ruleActionsAuditsService } = require('@ibm-aca/aca-rule-actions-service');
...
const deleteManyByIds = async (request, response) => {
  ...
  try {
    ...
    params = { ids };
    result = await ruleActionsAuditsService.deleteManyByIds(context, params);
  } catch (error) {
