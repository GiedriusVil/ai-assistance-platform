...
*/
const MODULE_ID = 'aca-rule-actions-express-routes-controller-actions-audits-find-many-by-query';
...
const findManyByQuery = async (request, response) => {
  ...
  try {
    ...
    result = await ruleActionsAuditsService.findManyByQuery(context, params);
  } catch (error) {
