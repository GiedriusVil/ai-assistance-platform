...
*/
const MODULE_ID = 'aca-catalog-rules-service-rules-export-many';
...
const { getCatalogRulesDatasource, getFindManyQuery } = require('../datasource.utils');
...
const exportMany = async (context, params) => {
    ...
    try {
        ...
        for (const RULE of RULES) {
            ...
            const CATALOGS = await DATASOURCE.rulesCatalogs.findManyByQuery(context, QUERY);
            RULE['catalogs'] = ramda.pathOr([], ['items'], CATALOGS);
        }
