...
*/
const MODULE_ID = 'aca-catalog-rules-service-rules-delete-many-by-ids';
  ...
  try {
    ...
    if (
      ...
      for (let ruleId of PARAMS_IDS) {
        ...
        PROMISES.push(DATASOURCE.rulesCatalogs.deleteManyByRuleId(context, { ruleId }));
      }
    }
    await Promise.all(PROMISES);
