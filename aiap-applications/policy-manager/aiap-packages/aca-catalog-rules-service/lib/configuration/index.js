...
const MODULE_ID = 'aca-catalog-rules-service-configurator';
...
const { CATALOG_RULES_SERVICE_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer')

class Configurator {

    static NAME = 'catalogRulesService';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: CATALOG_RULES_SERVICE_SCHEMA,
        };
        return RET_VAL;
    }
