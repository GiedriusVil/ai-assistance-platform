...
*/
const MODULE_ID = 'aca-classification-rules-service-classification-rules-classifications-find-many-by-query';
...
const _findManyByQuery = async (context, params) => {
    ...
    try {
        ...
        const RET_VAL = await DATASOURCE.rulesClassifications.findManyByQuery(context, params);
        return RET_VAL;
    } catch (error) {
