...
*/
const MODULE_ID = 'aca-classification-rules-service-classification-rules-classifications-find-one-by-id';
...
const _findOneById = async (context, params) => {
    ...
    try {
        ...
        const RET_VAL = await DATASOURCE.rulesClassifications.findOneById(context, params);
        return RET_VAL;
    } catch (error) {
