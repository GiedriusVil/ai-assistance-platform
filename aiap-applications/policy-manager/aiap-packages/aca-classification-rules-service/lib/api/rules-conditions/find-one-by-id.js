...
*/
const MODULE_ID = 'aca-classification-rules-service-classification-rules-conditions-find-one-by-id';
...
const _findOneById = async (context, params) => {
    ...
    try {
        ...
        const RET_VAL = await DATASOURCE.rulesConditions.findOneById(context, params);
        return RET_VAL;
    } catch (error) {
