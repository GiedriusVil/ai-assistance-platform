...
const MODULE_ID = 'aca-classification-rules-service-configurator';
...
const { CLASSIFICATION_RULES_SERVICE_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer')

class Configurator {

    static NAME = 'classificationRulesService';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: CLASSIFICATION_RULES_SERVICE_SCHEMA,
        };
        return RET_VAL;
    }
