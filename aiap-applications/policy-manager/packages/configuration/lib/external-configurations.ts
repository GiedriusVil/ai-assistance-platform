...
*/
const MODULE_ID = 'aiap-policy-manager-external-configurations';
...
const EXTERNAL_LIBRARIES_LIST = [
  ...
  '@ibm-aca/aca-rules-datasource-provider',
  '@ibm-aca/aca-rules-service',
  '@ibm-aca/aca-organizations-datasource-provider',
  '@ibm-aca/aca-organizations-service',
  '@ibm-aca/aca-policy-engine-api',
  ...
  '@ibm-aca/aca-metrics-datasource-provider',
  '@ibm-aiap/aiap-tenants-cache-provider',
  '@ibm-aiap/aiap-tenants-resources-loader',
  '@ibm-aiap/aiap-main-event-stream-handler',
  '@ibm-aca/aca-doc-validation-service',
  '@ibm-aca/aca-doc-validation-datasource-provider',
  '@ibm-aiap/aiap-ibm-secrets-manager-client-provider',
  '@ibm-aca/aca-rule-actions-datasource-provider',
  '@ibm-aca/aca-rule-actions-service',
  '@ibm-aca/aca-buy-rules-datasource-provider',
  '@ibm-aca/aca-buy-rules-service',
  '@ibm-aca/aca-catalog-rules-datasource-provider',
  '@ibm-aca/aca-catalog-rules-service',
  '@ibm-aca/aca-classification-rules-datasource-provider',
  '@ibm-aca/aca-classification-rules-service',

  '@ibm-aca/aca-validation-engagements-datasource-provider',
  '@ibm-aca/aca-validation-engagements-service',
  '@ibm-aca/aca-rules-datasource-provider-v2',
  '@ibm-aca/aca-rules-service-v2',
];
