...
const HTML_TAG = 'aiap-wbc-view-organizations-import-v1';

@Component({
  selector: 'aiap-wbc-view-root-organizations-import-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewOrganizationsImportV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewOrganizationsImportV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewOrganizationsImportV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewOrganizationsImportV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewOrganizationsImportV1.getElementTag();
    return RET_VAL;
  }
