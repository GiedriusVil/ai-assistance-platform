...
import { AiapWbcViewOrganizationsImportV1 } from './app';

@NgModule({
  declarations: [
    AiapWbcViewOrganizationsImportV1,
    // view
    OrganizationsImportViewV1,
    OrganizationClearModalV1,
  ],
  ...
  entryComponents: [AiapWbcViewOrganizationsImportV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewOrganizationsImportV1, { injector: this.injector });
    customElements.define(AiapWbcViewOrganizationsImportV1.getElementTag(), ELEMENT);
  }
}
