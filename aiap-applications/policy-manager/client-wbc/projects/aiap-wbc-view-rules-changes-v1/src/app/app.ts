...
const HTML_TAG = 'aiap-wbc-view-rules-changes-v1';

@Component({
  selector: 'aiap-wbc-view-root-rules-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRulesChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRulesChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRulesChangesV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewRulesChangesV1.getClassName(), 'ngOnChanges', { wbc });
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRulesChangesV1.getElementTag();
    return RET_VAL;
  }
