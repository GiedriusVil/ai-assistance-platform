...
import {
  IsConditionValueAllowedDirective,
} from './directives';
...
import { AiapWbcViewRulesV2 } from './app';
...
@NgModule({
  ...
  entryComponents: [AiapWbcViewRulesV2]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewRulesV2, { injector: this.injector });
    customElements.define(AiapWbcViewRulesV2.getElementTag(), ELEMENT);
  }
}
