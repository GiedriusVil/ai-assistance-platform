...
const HTML_TAG = 'aiap-wbc-view-doc-validations-v2';

@Component({
  selector: 'aiap-wbc-view-root-doc-validations-v2',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewDocValidationsV2 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewDocValidationsV2`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewDocValidationsV2.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewDocValidationsV2.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewDocValidationsV2.getElementTag();
    return RET_VAL;
  }
