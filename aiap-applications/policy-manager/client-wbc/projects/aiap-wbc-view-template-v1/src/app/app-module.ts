...
import { AiapWbcViewTemplateV1 } from './app';
...
@NgModule({
  ...
  entryComponents: [AiapWbcViewTemplateV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewTemplateV1, { injector: this.injector });
    customElements.define(AiapWbcViewTemplateV1.getElementTag(), ELEMENT);
  }
}
