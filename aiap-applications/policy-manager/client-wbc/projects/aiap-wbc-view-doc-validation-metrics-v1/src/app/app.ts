...
const HTML_TAG = 'aiap-wbc-view-doc-validation-metrics-v1';

@Component({
  selector: 'aiap-wbc-view-root-doc-validation-metrics-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewDocValidationMetricsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewDocValidationMetricsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewDocValidationMetricsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      ...
      _errorW(AiapWbcViewDocValidationMetricsV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewDocValidationMetricsV1.getElementTag();
    return RET_VAL;
  }
