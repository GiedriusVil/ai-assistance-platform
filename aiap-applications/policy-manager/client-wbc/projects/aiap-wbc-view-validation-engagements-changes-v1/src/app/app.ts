...
const HTML_TAG = 'aiap-wbc-view-validation-engagements-changes-v1';

@Component({
  selector: 'aiap-wbc-view-root-validation-engagements-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewValidationEngagementsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewValidationEngagementsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugX(AiapWbcViewValidationEngagementsChangesV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorX(AiapWbcViewValidationEngagementsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewValidationEngagementsChangesV1.getElementTag();
    return RET_VAL;
  }
