...
const HTML_TAG = 'aiap-wbc-view-rule-messages-import-v1';

@Component({
  selector: 'aiap-wbc-view-root-rule-messages-import-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRuleMessagesImportV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRuleMessagesImportV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRuleMessagesImportV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewRuleMessagesImportV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRuleMessagesImportV1.getElementTag();
    return RET_VAL;
  }
