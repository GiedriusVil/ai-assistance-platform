...
const HTML_TAG = 'aiap-wbc-view-rule-messages-changes-v1';

@Component({
  selector: 'aiap-wbc-view-root-rule-messages-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRuleMessagesChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRuleMessagesChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRuleMessagesChangesV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewRuleMessagesChangesV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRuleMessagesChangesV1.getElementTag();
    return RET_VAL;
  }
