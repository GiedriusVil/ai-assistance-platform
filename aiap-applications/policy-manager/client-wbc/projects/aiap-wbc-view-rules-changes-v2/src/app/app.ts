...
const HTML_TAG = 'aiap-wbc-view-rules-changes-v2';

@Component({
  selector: 'aiap-wbc-view-root-rules-changes-v2',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRulesChangesV2 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRulesChangesV2`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRulesChangesV2.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewRulesChangesV2.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRulesChangesV2.getElementTag();
    return RET_VAL;
  }
