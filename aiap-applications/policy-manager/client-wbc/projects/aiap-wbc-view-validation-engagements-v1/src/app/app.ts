...
const HTML_TAG = 'aiap-wbc-view-validation-engagements-v1';

@Component({
  selector: 'aiap-wbc-view-root-validation-engagements-view-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewValidationEngagementsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewValidationEngagementsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewValidationEngagementsV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewValidationEngagementsV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewValidationEngagementsV1.getElementTag();
    return RET_VAL;
  }
