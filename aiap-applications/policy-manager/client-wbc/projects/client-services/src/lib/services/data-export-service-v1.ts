...
@Injectable()
export class DataExportServiceV1 {
   ...
   */
  exportJsonToExcel(json: IExcelJsonV1[], fileName: string, sheetName = 'Sheet1'): void {
   ...
   */
  private getOptions(json: IExcelJsonV1, origin?: number): any {
    // adding actual data
    const options = {
      skipHeader: true,
      origin: -1,
