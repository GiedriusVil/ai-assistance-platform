...
@Injectable()
export class DocValidationsServiceV2 extends BaseServiceV1 {

  static getClassName() {
    return 'DocValidationsServiceV2';
  }
  ...
  findManyByQuery(query: any) {
    ...
    _debugX(DocValidationsServiceV2.getClassName(), 'findManyByQuery', { REQUEST_URL, REQUEST });
  ...
  exportMany(query: any) {
    ...
    const REQUEST_HEADERS = this.getAuthHeaders();
    _debugX(DocValidationsServiceV2.getClassName(), 'exportMany', { REQUEST_URL, REQUEST_HEADERS });
  ...
  report(query: any) {
    ...
    _debugX(DocValidationsServiceV2.getClassName(), 'report', { REQUEST_URL, REQUEST_HEADERS, REQUEST_BODY });
