...
const HTML_TAG = 'aiap-wbc-view-doc-validation-metrics-v2';

@Component({
  selector: 'aiap-wbc-view-root-doc-validation-metrics-v2',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewDocValidationMetricsV2 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewDocValidationMetricsV2`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewDocValidationMetricsV2.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewDocValidationMetricsV2.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewDocValidationMetricsV2.getElementTag();
    return RET_VAL;
  }
