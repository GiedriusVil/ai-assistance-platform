...
const HTML_TAG = 'aiap-wbc-form-purchase-rule-outcome-v1';

@Component({
  selector: 'aiap-wbc-form-root-purchase-rule-outcome-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcFormPurchaseRuleOutcomeV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcFormPurchaseRuleOutcomeV1`;
  }
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    try {
      ...
      _debugW(AiapWbcFormPurchaseRuleOutcomeV1.getClassName(), 'ngOnChanges',
        {
          changes
        });
      ...
      _errorW(AiapWbcFormPurchaseRuleOutcomeV1.getClassName(), 'ngOnChanges', { wbc });
  ...
  handleValueChange(event: any) {
    _debugW(AiapWbcFormPurchaseRuleOutcomeV1.getClassName(), 'handleValueChange',
      {
        event: event,
  ...
  private elCSSLinkId() {
    return AiapWbcFormPurchaseRuleOutcomeV1.getElementTag();
  }
  ...
  private async loadHTMLDependencies() {
    ...
    _debugW(AiapWbcFormPurchaseRuleOutcomeV1.getClassName(), 'loadHTMLDependencies', {
      EL_CSS_LINK_ID,
      CLIENT_WBC_URL_BASE,
