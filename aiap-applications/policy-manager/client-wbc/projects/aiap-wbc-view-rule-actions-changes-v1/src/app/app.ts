...
const HTML_TAG = 'aiap-wbc-view-rule-actions-changes-v1';

@Component({
  selector: 'aiap-wbc-view-root-rule-actions-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRuleActionsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRuleActionsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRuleActionsChangesV1.getClassName(), 'ngOnChanges', { changes });
      ...
      _errorW(AiapWbcViewRuleActionsChangesV1.getClassName(), 'ngOnChanges', { wbc });
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRuleActionsChangesV1.getElementTag();
    return RET_VAL;
  }
