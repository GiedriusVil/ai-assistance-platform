...
import { AiapWbcViewRuleActionsChangesV1 } from './app';
...
@NgModule({
  declarations: [
    AiapWbcViewRuleActionsChangesV1,
    // view
    RuleActionsChangesViewV1,
    RuleActionsChangesModalV1,
  ],
  ...
  entryComponents: [AiapWbcViewRuleActionsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewRuleActionsChangesV1, { injector: this.injector });
    customElements.define(AiapWbcViewRuleActionsChangesV1.getElementTag(), ELEMENT);
  }
}
