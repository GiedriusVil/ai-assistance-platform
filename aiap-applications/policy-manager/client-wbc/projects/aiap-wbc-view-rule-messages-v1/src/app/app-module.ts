...
import { AiapWbcViewRuleMessagesV1 } from './app';
...
@NgModule({
  ...
  entryComponents: [AiapWbcViewRuleMessagesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewRuleMessagesV1, { injector: this.injector });
    customElements.define(AiapWbcViewRuleMessagesV1.getElementTag(), ELEMENT);
  }
}
