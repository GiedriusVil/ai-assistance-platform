...
import { AiapWbcViewRulesV1 } from './app';
import {
  RulesExportModalV1,
  RulesPullModalV1,
  RulesViewV1,
...
@NgModule({
  ...
  entryComponents: [AiapWbcViewRulesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewRulesV1, { injector: this.injector });
    customElements.define(AiapWbcViewRulesV1.getElementTag(), ELEMENT);
  }
}
