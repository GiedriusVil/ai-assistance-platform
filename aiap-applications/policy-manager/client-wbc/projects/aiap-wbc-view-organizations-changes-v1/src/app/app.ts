...
const HTML_TAG = 'aiap-wbc-view-organizations-changes-v1';

@Component({
  selector: 'aiap-wbc-view-root-organizations-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewOrganizationsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewOrganizationsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewOrganizationsChangesV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewOrganizationsChangesV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewOrganizationsChangesV1.getElementTag();
    return RET_VAL;
  }
