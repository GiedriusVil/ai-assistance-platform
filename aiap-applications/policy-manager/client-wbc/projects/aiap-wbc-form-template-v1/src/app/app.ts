...
const HTML_TAG = 'aiap-wbc-form-template-v1';

@Component({
  selector: 'aiap-wbc-form-root-template-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcFormTemplateV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcFormTemplateV1`;
  }
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    try {
      ...
      _debugW(AiapWbcFormTemplateV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcFormTemplateV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  handleValueChange(event: any) {
    _debugW(
      AiapWbcFormTemplateV1.getClassName(),
      'handleValueChange',
      {
        event: event,
  ...
  private elCSSLinkId() {
    return AiapWbcFormTemplateV1.getElementTag();
  }
  ...
  private async loadHTMLDependencies() {
    ...
    _debugW(AiapWbcFormTemplateV1.getClassName(), 'loadHTMLDependencies', {
      EL_CSS_LINK_ID,
      CLIENT_WBC_URL_BASE,
