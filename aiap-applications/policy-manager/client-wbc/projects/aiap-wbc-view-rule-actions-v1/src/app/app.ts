...
const HTML_TAG = 'aiap-wbc-view-rule-actions-v1';

@Component({
  selector: 'aiap-wbc-view-root-rule-actions-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRuleActionsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRuleActionsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRuleActionsV1.getClassName(), 'ngOnChanges', { changes });
      ...
      _errorW(AiapWbcViewRuleActionsV1.getClassName(), 'ngOnChanges', { wbc });
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRuleActionsV1.getElementTag();
    return RET_VAL;
  }
