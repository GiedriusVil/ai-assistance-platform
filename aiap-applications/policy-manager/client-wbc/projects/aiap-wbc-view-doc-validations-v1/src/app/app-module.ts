...
import { AiapWbcViewDocValidationsV1 } from './app';
...
@NgModule({
  ...
  entryComponents: [AiapWbcViewDocValidationsV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewDocValidationsV1, { injector: this.injector });
    customElements.define(AiapWbcViewDocValidationsV1.getElementTag(), ELEMENT);
  }
}
