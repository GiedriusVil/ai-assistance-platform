...
import { AiapWbcViewRulesImportV1 } from './app';
...
@NgModule({
  ...
  entryComponents: [AiapWbcViewRulesImportV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewRulesImportV1, { injector: this.injector });
    customElements.define(AiapWbcViewRulesImportV1.getElementTag(), ELEMENT);
  }
}
