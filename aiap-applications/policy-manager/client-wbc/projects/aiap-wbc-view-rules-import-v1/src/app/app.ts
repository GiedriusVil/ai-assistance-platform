...
const HTML_TAG = 'aiap-wbc-view-rules-import-v1';

@Component({
  selector: 'aiap-wbc-view-root-rules-import-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewRulesImportV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewRulesImportV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewRulesImportV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewRulesImportV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewRulesImportV1.getElementTag();
    return RET_VAL;
  }
