...
const HTML_TAG = 'aiap-wbc-view-conversations-v1';

@Component({
  selector: 'aiap-wbc-view-root-conversations-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewConversationsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewConversationsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewConversationsV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewConversationsV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewConversationsV1.getElementTag();
    return RET_VAL;
  }
