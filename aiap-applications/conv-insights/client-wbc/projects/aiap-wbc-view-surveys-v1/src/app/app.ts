...
const HTML_TAG = 'aiap-wbc-view-surveys-v1';

@Component({
  selector: 'aiap-wbc-view-root-surveys-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewSurveysV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewSurveysV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewSurveysV1.getClassName(), 'ngOnChanges', { changes });
      if (
      ...
      _errorW(AiapWbcViewSurveysV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewSurveysV1.getElementTag();
    return RET_VAL;
  }
