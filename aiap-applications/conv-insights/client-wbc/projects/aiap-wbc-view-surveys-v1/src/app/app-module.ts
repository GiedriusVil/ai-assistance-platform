...
import { AiapWbcViewSurveysV1 } from './app';

@NgModule({
  declarations: [
    AiapWbcViewSurveysV1,
    // view
    SurveysViewV1,
  ],
  imports: [
  ...
  entryComponents: [AiapWbcViewSurveysV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewSurveysV1, { injector: this.injector });
    customElements.define(AiapWbcViewSurveysV1.getElementTag(), ELEMENT);
  }
}
