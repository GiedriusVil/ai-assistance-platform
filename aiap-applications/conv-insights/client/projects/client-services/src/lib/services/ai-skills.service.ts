...
@Injectable()
export class AiSkillsService extends BaseServiceV1 {

  static getClassName() {
    return 'AiSkillsService';
  }
  ...
  findManyByQuery(query: any) {
    ...
    _debugX(AiSkillsService.getClassName(), 'findManyByQuery', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
  ...
  findOneById(id: any) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiSkillsService.getClassName(), 'findOneById', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
    return RET_VAL;
  }
  ...
  deleteManyByIds(ids: any, aiServiceId: any) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiSkillsService.getClassName(), 'deleteManyByIds', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
    return RET_VAL;
  }
  ...
  pullOneById(aiSkillId: any, aiServiceId: any) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiSkillsService.getClassName(), 'pullAiSkill', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
  ...
  syncManyByFiles(files: Array<File>, aiServiceId: any) {
    ...
    _debugX(AiSkillsService.getClassName(), 'syncManyByFiles', { REQUEST_HEADERS, REQUEST_URL, REQUEST_BODY });
  ...
  syncManyByIds(ids: any, aiServiceId: any, options: any = {}) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiSkillsService.getClassName(), 'syncManyByIds', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
    return RET_VAL;
  }
  ...
  syncOneById(id: any) {
    ...
    const REQUEST = { id };
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiSkillsService.getClassName(), 'syncOneById', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
    return RET_VAL;
  }
  ...
  pullManyByIds(ids: any, aiServiceId: any) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiSkillsService.getClassName(), 'pullManyByIds', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
    return RET_VAL;
  }
