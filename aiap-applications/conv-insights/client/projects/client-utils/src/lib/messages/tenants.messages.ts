...
export const TENANTS_MESSAGES = {
    SUCCESS: {
        ...
        IMPORT_MANY_BY_QUERY: {
            type: 'success',
            message: 'Tenants were imported',
            ...CONFIGURATION_SUCCESS
        },
        DELETE_MANY_BY_IDS: {
            type: 'success',
            message: 'Tenants were deleted',
            ...CONFIGURATION_SUCCESS
        }
    },
    WARNING: {
    ...
    ERROR: {
        ...
        IMPORT_MANY_BY_QUERY: {
            type: 'error',
            message: 'Unable to import tenants!',
            ...CONFIGURATION_FAILURE
        },
        DELETE_MANY_BY_IDS: {
            type: 'error',
            message: 'Unable to delete tenants!',
            ...CONFIGURATION_FAILURE
        },
        SHOW_TENANT_DELETE_MODAL: {
            type: 'error',
            message: 'Unable to show Tenant delete modal',
            ...CONFIGURATION_FAILURE
        },
    }
};