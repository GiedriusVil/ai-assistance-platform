...
*/
const MODULE_ID = 'aiap-conversation-insights';
...
(async () => {
  try {
    ...
    const configurationProvider = require('@ibm-aiap/aiap-conv-insights-configuration');
    ...
    await require('@ibm-aca/aca-topic-modeling-datasource-provider').initByConfigurationProvider(configurationProvider);
    await require('@ibm-aca/aca-topic-modeling-service').initByConfigurationProvider(configurationProvider);
