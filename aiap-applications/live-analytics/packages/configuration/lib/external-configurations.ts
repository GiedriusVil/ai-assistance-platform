...
*/
const MODULE_ID = 'aiap-live-analytics';
...
const EXTERNAL_LIBRARIES_LIST = [
  ...
  '@ibm-aca/aca-live-analytics-datasource-provider',
  '@ibm-aca/aca-live-analytics-queries-executor',
  '@ibm-aca/aca-live-analytics-filters-executor',
  '@ibm-aca/aca-live-analytics-charts-service',
  '@ibm-aca/aca-live-analytics-dashboards-service',
  '@ibm-aca/aca-live-analytics-filters-service',
  '@ibm-aca/aca-live-analytics-queries-service',
  '@ibm-aca/aca-live-analytics-tiles-service',
];
