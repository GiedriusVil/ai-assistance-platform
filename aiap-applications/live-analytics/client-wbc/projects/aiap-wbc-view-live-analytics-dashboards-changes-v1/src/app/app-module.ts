...
import {
  DashboardsModelChangeViewModalV1,
  DashboardsModelsChangesTableV1,
} from './components';
...
import { WbcViewDashboardsModelsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewDashboardsModelsChangesV1,
    // view
    DashboardsModelsChangesViewV1,
    // components
    DashboardsModelChangeViewModalV1,
  ...
  entryComponents: [WbcViewDashboardsModelsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewDashboardsModelsChangesV1, { injector: this.injector });
    customElements.define(WbcViewDashboardsModelsChangesV1.getElementTag(), ELEMENT);
  }
}
