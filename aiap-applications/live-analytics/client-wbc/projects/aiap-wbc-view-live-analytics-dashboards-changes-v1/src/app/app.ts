...
const HTML_TAG = 'aiap-wbc-view-live-analytics-dashboards-changes-v1';

@Component({
  selector: 'aiap-wbc-view-dashboards-models-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewDashboardsModelsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewDashboardsModelsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewDashboardsModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewDashboardsModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewDashboardsModelsChangesV1.getElementTag();
    return RET_VAL;
  }
