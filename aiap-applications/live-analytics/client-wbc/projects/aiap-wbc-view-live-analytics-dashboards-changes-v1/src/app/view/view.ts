...
export class DashboardsModelsChangesViewV1 extends BaseChangesViewV1 implements OnInit, OnDestroy {

  static getClassName() {
    return 'DashboardsModelsChangesViewV1';
  }

  @ViewChild('dashboardsModelChangeViewModalV1') dashboardsModelChangesViewV1: DashboardsModelChangeViewModalV1;
  ...
  protected getChangesViewModal(): { show(value: any): void; } {
    return this.dashboardsModelChangesViewV1;
  }
