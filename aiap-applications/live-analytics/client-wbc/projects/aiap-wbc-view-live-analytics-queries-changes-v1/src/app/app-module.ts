...
import {
  QueriesModelChangeViewModalV1,
  QueriesModelsChangesTableV1,
} from './components';
...
import { WbcViewQueriesModelsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewQueriesModelsChangesV1,
    // view
    QueriesModelsChangesViewV1,
    // components
    QueriesModelChangeViewModalV1,
  ...
  entryComponents: [WbcViewQueriesModelsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewQueriesModelsChangesV1, { injector: this.injector });
    customElements.define(WbcViewQueriesModelsChangesV1.getElementTag(), ELEMENT);
  }
}
