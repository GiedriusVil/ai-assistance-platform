...
const HTML_TAG = 'aiap-wbc-view-live-analytics-charts-changes-v1';

@Component({
  selector: 'aiap-wbc-view-charts-models-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewChartsModelsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewChartsModelsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewChartsModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewChartsModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewChartsModelsChangesV1.getElementTag();
    return RET_VAL;
  }
