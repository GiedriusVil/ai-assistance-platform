...
import { WbcViewTilesModelsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewTilesModelsChangesV1,
    // view
    TilesModelsChangesViewV1,
    // components
    TilesModelChangeViewModalV1,
  ...
  entryComponents: [WbcViewTilesModelsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewTilesModelsChangesV1, { injector: this.injector });
    customElements.define(WbcViewTilesModelsChangesV1.getElementTag(), ELEMENT);
  }
}
