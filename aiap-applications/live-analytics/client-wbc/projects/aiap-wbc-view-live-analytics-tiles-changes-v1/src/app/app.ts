...
const HTML_TAG = 'aiap-wbc-view-live-analytics-tiles-changes-v1';

@Component({
  selector: 'aiap-wbc-view-live-analytics-tiles-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewTilesModelsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewTilesModelsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewTilesModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewTilesModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewTilesModelsChangesV1.getElementTag();
    return RET_VAL;
  }
