...
import {
  FiltersModelChangeViewModalV1,
  FiltersModelsChangesTableV1,
} from './components';
...
import { WbcViewFiltersModelsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewFiltersModelsChangesV1,
    // view
    FiltersModelsChangesViewV1,
    // components
    FiltersModelChangeViewModalV1,
  ...
  entryComponents: [WbcViewFiltersModelsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewFiltersModelsChangesV1, { injector: this.injector });
    customElements.define(WbcViewFiltersModelsChangesV1.getElementTag(), ELEMENT);
  }
}
