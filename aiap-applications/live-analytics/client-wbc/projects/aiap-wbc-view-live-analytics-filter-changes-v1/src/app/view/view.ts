...
export class FiltersModelsChangesViewV1 extends BaseChangesViewV1 implements OnInit, OnDestroy {

  static getClassName() {
    return 'FiltersModelsChangesViewV1';
  }

  @ViewChild('filtersModelChangeViewModalV1') filtersModelChangesViewV1: FiltersModelChangeViewModalV1;
  ...
  protected getChangesViewModal(): { show(value: any): void; } {
    return this.filtersModelChangesViewV1;
  }
