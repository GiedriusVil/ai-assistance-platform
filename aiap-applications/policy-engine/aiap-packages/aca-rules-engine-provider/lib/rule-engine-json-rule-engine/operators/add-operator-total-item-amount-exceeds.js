...
*/
const MODULE_ID = 'aca-rules-engine-provider-json-rule-engine-operator-total-item-amount-exceeds';
...
const addOperatorTotalItemAmountExceeds = (operators) => {
  operators.push(new Operator('totalItemAmountExceeds', VALIDATOR));
}

module.exports = {
  addOperatorTotalItemAmountExceeds,
}
