...
*/
const MODULE_ID = `aca-json-rule-engine-operators-default-add-operator-contains`;
...
const addOperatorContains = (operators) => {
  operators.push(new Operator('contains', VALIDATOR));
}
