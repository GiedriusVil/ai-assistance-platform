...
*/
const MODULE_ID = `aca-json-rule-engine-operators-default-add-operator-less-than`;
...
const addOperatorLessThanInclusive = (operators) => {
  operators.push(new Operator('lessThanInclusive', VALIDATOR));
}

module.exports = {
  addOperatorLessThanInclusive,
}
