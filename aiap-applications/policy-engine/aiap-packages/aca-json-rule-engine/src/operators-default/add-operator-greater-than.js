...
*/
const MODULE_ID = `aca-json-rule-engine-operators-default-add-operator-greater-than`;
...
const addOperatorGreaterThan = (operators) => {
  operators.push(new Operator('greaterThan', VALIDATOR));
}

module.exports = {
  addOperatorGreaterThan,
}
