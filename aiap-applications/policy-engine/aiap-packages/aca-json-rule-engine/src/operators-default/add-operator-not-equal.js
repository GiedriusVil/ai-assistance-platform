...
*/
const MODULE_ID = `aca-json-rule-engine-operators-default-add-operator-not-equal`;
...
const addOperatorNotEqual = (operators) => {
  operators.push(new Operator('notEqual', VALIDATOR));
}
