...
*/
const MODULE_ID = `aca-json-rule-engine-operators-default-add-operator-greater-than-inclusive`;
...
const _operator = (factValue, conditionValue) => {
  const RET_VAL = factValue > conditionValue;
  return RET_VAL;
}
...
const addOperatorGreaterThanInclusive = (operators) => {
  operators.push(new Operator('greaterThanInclusive', VALIDATOR));
}

module.exports = {
  addOperatorGreaterThanInclusive,
}
