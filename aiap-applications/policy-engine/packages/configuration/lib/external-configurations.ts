...
*/
const MODULE_ID = 'aiap-policy-engine-external-configurations';
...
const EXTERNAL_LIBRARIES_LIST = [
  ...
  '@ibm-aca/aca-rules-engine-provider',
  '@ibm-aca/aca-rules-engine-provider-v2',
  '@ibm-aca/aca-buy-rules-datasource-provider',
  '@ibm-aca/aca-buy-rules-engine-provider',
  '@ibm-aca/aca-catalog-rules-datasource-provider',
  '@ibm-aca/aca-catalog-rules-engine-provider',
  '@ibm-aca/aca-classification-rules-datasource-provider',
  '@ibm-aca/aca-classification-rules-engine-provider',
  ...
  '@ibm-aiap/aiap-express-midleware-provider',
