...
const HTML_TAG = 'aiap-wbc-view-engagements-changes-v1';

@Component({
  selector: 'aiap-wbc-view-engagements-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewEngagementsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewEngagementsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewEngagementsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewEngagementsChangesV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewEngagementsChangesV1.getElementTag();
    return RET_VAL;
  }
