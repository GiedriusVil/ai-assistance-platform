...
import { WbcViewEngagementsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewEngagementsChangesV1,
    // view
    EngagementsChangesViewV1,
    // components
    EngagementChangesViewModalV1,
  ...
  entryComponents: [WbcViewEngagementsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewEngagementsChangesV1, { injector: this.injector });
    customElements.define(WbcViewEngagementsChangesV1.getElementTag(), ELEMENT);
  }
}
