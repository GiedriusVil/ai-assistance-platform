...
const HTML_TAG = 'aiap-wbc-view-answer-v1';

@Component({
  selector: 'aiap-wbc-view-answer-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAnswerViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAnswerViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAnswerViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewAnswerViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAnswerViewV1.getElementTag();
    return RET_VAL;
  }
