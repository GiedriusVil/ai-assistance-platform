...
const HTML_TAG = 'aiap-wbc-view-ai-translation-models-changes-v1';

@Component({
  selector: 'aiap-wbc-view-ai-translation-models-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAiTranslationModelsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAiTranslationModelsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAiTranslationModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewAiTranslationModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAiTranslationModelsChangesV1.getElementTag();
    return RET_VAL;
  }
