...
import { AiapWbcViewClassificationCatalogsV1 } from './app';
import {
  ClassificationCatalogDeleteModalV1,
  ClassificationCatalogImportModalV1,
  ClassificationCatalogSaveModalV1,
  ClassificationCatalogsTableV1
} from './components';

@NgModule({
  declarations: [
    AiapWbcViewClassificationCatalogsV1,
    ClassificationCatalogsViewV1,
    ClassificationCatalogDeleteModalV1,
    ClassificationCatalogImportModalV1,
    ClassificationCatalogSaveModalV1,
  ...
  entryComponents: [AiapWbcViewClassificationCatalogsV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewClassificationCatalogsV1, { injector: this.injector });
    customElements.define(AiapWbcViewClassificationCatalogsV1.getElementTag(), ELEMENT);
  }
}
