...
const HTML_TAG = 'aiap-wbc-view-classification-catalogs-v1';

@Component({
  selector: 'aiap-wbc-view-classification-catalogs-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewClassificationCatalogsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewClassificationCatalogsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewClassificationCatalogsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewClassificationCatalogsV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewClassificationCatalogsV1.getElementTag();
    return RET_VAL;
  }
