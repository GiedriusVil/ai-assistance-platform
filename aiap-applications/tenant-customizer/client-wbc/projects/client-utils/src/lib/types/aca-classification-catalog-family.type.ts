...
export class AcaClassificationCatalogFamily implements AcaClassificationCatalogCategory {
  id: string;
  catalogId: string;
  segmentId: string;
  supplierName: string;
  ...
  public static of(arg: any): AcaClassificationCatalogFamily {
    let instance = new AcaClassificationCatalogFamily();
    if (arg != null) {
      instance.id = arg.id;
