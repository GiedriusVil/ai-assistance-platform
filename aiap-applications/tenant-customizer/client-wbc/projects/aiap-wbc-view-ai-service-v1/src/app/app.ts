...
const HTML_TAG = 'aiap-wbc-view-ai-service-v1';

@Component({
  selector: 'aiap-wbc-view-ai-service-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewAiServiceV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewAiServiceV1`;
  }
  ...
  constructor(
    ...
    protected activatedRouteServiceV1: ActivatedRouteServiceV1
  ) {
    super(
      environmentService,
      localStorageService,
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewAiServiceV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewAiServiceV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    } 
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewAiServiceV1.getElementTag();
    return RET_VAL;
  }
