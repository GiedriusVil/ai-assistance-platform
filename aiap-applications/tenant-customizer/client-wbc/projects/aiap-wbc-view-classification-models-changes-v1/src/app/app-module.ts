...
import {
  ...
  ClassifierModelsChangesTableV1,
} from './components';
...
import { WbcViewClassifierModelsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewClassifierModelsChangesV1,
    // view
    ClassifierModelsChangesViewV1,
    // components
    ClassifierModelChangeViewModalV1,
  ...
  entryComponents: [WbcViewClassifierModelsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewClassifierModelsChangesV1, { injector: this.injector });
    customElements.define(WbcViewClassifierModelsChangesV1.getElementTag(), ELEMENT);
  }
}
