...
const HTML_TAG = 'aiap-wbc-view-classifier-models-changes-v1';

@Component({
  selector: 'aiap-wbc-view-classifier-models-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewClassifierModelsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewClassifierModelsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewClassifierModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
        ...
        await this.initTranslations({
          app: wbc?.tag,
          host: wbc?.host,
          path: `/client-wbc/aiap-wbc-view-classification-models-changes-v1/assets/i18n`,
        });
      ...
      _errorW(WbcViewClassifierModelsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewClassifierModelsChangesV1.getElementTag();
    return RET_VAL;
  }
