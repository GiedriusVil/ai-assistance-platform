...
import {
  ...
  AiSearchAndAnalysisServiceSaveModelExternalWdsFormV1,
  AiSearchAndAnalysisServicesTableV1,
} from './components';

import { RoutingModule } from './modules/routing.module';
import { CarbonFrameworkModule } from './modules/carbon-framework.module';
import { WbcViewAiSearchAndAnalysisServicesViewV1 } from './app';

@NgModule({
  declarations: [
    WbcViewAiSearchAndAnalysisServicesViewV1,
    // view
    AiSearchAndAnalysisServicesViewV1,
    // components
    AiSearchAndAnalysisServiceDeleteModalV1,
  ...
  entryComponents: [WbcViewAiSearchAndAnalysisServicesViewV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewAiSearchAndAnalysisServicesViewV1,
      {
        injector: this.injector,
      });
    customElements.define(WbcViewAiSearchAndAnalysisServicesViewV1.getElementTag(), ELEMENT);
  }
}
