...
const HTML_TAG = 'aiap-wbc-view-ai-search-and-analysis-services-v1';

@Component({
  selector: 'aiap-wbc-viewai-search-and-analysis-services-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAiSearchAndAnalysisServicesViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAiSearchAndAnalysisServicesViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAiSearchAndAnalysisServicesViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewAiSearchAndAnalysisServicesViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAiSearchAndAnalysisServicesViewV1.getElementTag();
    return RET_VAL;
  }
