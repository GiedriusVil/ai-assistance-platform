...
import {
  ...
  AiSearchAndAnalysisCollectionsTableV1,
} from './components';
...
import { WbcViewAiSearchAndAnalysisCollectionsV1 } from './app';

@NgModule({
  declarations: [
    WbcViewAiSearchAndAnalysisCollectionsV1,
    // view
    AiSearchAndAnalysisCollectionsViewV1,
    // components
    AiSearchAndAnalysisCollectionDeleteModalV1,
  ...
  entryComponents: [WbcViewAiSearchAndAnalysisCollectionsV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewAiSearchAndAnalysisCollectionsV1,
      {
        injector: this.injector,
      });
    customElements.define(WbcViewAiSearchAndAnalysisCollectionsV1.getElementTag(), ELEMENT);
  }
