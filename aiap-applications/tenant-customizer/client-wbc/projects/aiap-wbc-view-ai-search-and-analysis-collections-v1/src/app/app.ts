...
const HTML_TAG = 'aiap-wbc-view-ai-search-and-analysis-collections-v1';

@Component({
  selector: 'aiap-wbc-view-ai-search-and-analysis-collections-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAiSearchAndAnalysisCollectionsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAiSearchAndAnalysisCollectionsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAiSearchAndAnalysisCollectionsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      ...
      _errorW(WbcViewAiSearchAndAnalysisCollectionsV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAiSearchAndAnalysisCollectionsV1.getElementTag();
    return RET_VAL;
  }
