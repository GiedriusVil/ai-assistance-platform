...
import {
  ObjectStorageFilesChangesTableV1,
...
import { WbcViewObjectStorageFilesChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewObjectStorageFilesChangesV1,
    // view
    ObjectStorageFilesChangesViewV1,
    // components
    ObjectStorageFilesChangesTableV1,
  ...
  entryComponents: [WbcViewObjectStorageFilesChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewObjectStorageFilesChangesV1, { injector: this.injector });
    customElements.define(WbcViewObjectStorageFilesChangesV1.getElementTag(), ELEMENT);
  }
}
