...
const HTML_TAG = 'aiap-wbc-view-object-storage-files-changes-v1';

@Component({
  selector: 'aiap-wbc-view-object-storage-files-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewObjectStorageFilesChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewObjectStorageFilesChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewObjectStorageFilesChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewObjectStorageFilesChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewObjectStorageFilesChangesV1.getElementTag();
    return RET_VAL;
  }
