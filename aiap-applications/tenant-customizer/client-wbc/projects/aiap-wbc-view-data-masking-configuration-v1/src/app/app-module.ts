...
import {
  DataMaskingConfigurationsTableV1,
...
import {
  WbcViewDataMaskingConfigurationViewV1
} from './app';
import { DataMaskingConfigurationViewV1 } from './view';
...
@NgModule({
  ...
  entryComponents: [WbcViewDataMaskingConfigurationViewV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewDataMaskingConfigurationViewV1,
      {
        injector: this.injector,
      });
    customElements.define(WbcViewDataMaskingConfigurationViewV1.getElementTag(), ELEMENT);
  }
}
