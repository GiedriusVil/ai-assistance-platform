...
const HTML_TAG = 'aiap-wbc-view-data-masking-configuration-v1';

@Component({
  selector: 'aiap-wbc-view-data-masking-configuration-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})

export class WbcViewDataMaskingConfigurationViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewDataMaskingConfigurationViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewDataMaskingConfigurationViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewDataMaskingConfigurationViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewDataMaskingConfigurationViewV1.getElementTag();
    return RET_VAL;
  }
