...
import { WbcViewAnswersViewV1 } from './app';

@NgModule({
  declarations: [
    WbcViewAnswersViewV1,
    // view
    AnswersViewV1,
    // components
    AnswerDeleteModalV1,
  ...
  entryComponents: [WbcViewAnswersViewV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewAnswersViewV1,
      {
        injector: this.injector,
      });
    customElements.define(WbcViewAnswersViewV1.getElementTag(), ELEMENT);
  }
}
