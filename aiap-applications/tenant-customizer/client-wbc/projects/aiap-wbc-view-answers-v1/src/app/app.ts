...
const HTML_TAG = 'aiap-wbc-view-answers-v1';

@Component({
  selector: 'aiap-wbc-view-answers-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAnswersViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAnswersViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAnswersViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewAnswersViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAnswersViewV1.getElementTag();
    return RET_VAL;
  }
