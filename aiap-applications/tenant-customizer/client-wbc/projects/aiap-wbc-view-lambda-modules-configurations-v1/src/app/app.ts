...
const HTML_TAG = 'aiap-wbc-view-lambda-modules-configurations-v1';

@Component({
  selector: 'aiap-wbc-view-lambda-modules-configurations-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewLambdaModulesConfigurationsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {
  static getClassName(): string {
    return 'AiapWbcViewLambdaModulesConfigurationsV1'
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewLambdaModulesConfigurationsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewLambdaModulesConfigurationsV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewLambdaModulesConfigurationsV1.getElementTag();
    return RET_VAL;
  }
