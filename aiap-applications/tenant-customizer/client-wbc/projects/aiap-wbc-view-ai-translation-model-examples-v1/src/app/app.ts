...
const HTML_TAG = 'aiap-wbc-view-ai-translation-model-examples-v1';

@Component({
  selector: 'aiap-wbc-view-ai-translation-model-examples-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewAiTranslationModelExamplesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewAiTranslationModelExamplesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewAiTranslationModelExamplesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewAiTranslationModelExamplesV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewAiTranslationModelExamplesV1.getElementTag();
    return RET_VAL;
  }
