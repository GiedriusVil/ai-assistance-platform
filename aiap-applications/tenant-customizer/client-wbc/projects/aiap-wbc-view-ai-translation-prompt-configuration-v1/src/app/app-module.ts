...
import { AiapWbcViewAiTranslationPromptConfigurationV1 } from './app';

@NgModule({
  declarations: [
    AiapWbcViewAiTranslationPromptConfigurationV1,
    // view
    AiTranslationPromptConfigurationViewV1,
    // components
    AiTranslationPromptTestModalV1,
  ...
  entryComponents: [AiapWbcViewAiTranslationPromptConfigurationV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewAiTranslationPromptConfigurationV1, { injector: this.injector });
    customElements.define(AiapWbcViewAiTranslationPromptConfigurationV1.getElementTag(), ELEMENT);
  }
}
