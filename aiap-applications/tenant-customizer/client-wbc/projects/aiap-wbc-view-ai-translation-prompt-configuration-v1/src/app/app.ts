...
const HTML_TAG = 'aiap-wbc-view-ai-translation-prompt-configuration-v1';

@Component({
  selector: 'aiap-wbc-view-ai-translation-prompt-configuration-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewAiTranslationPromptConfigurationV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewAiTranslationPromptConfigurationV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewAiTranslationPromptConfigurationV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewAiTranslationPromptConfigurationV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewAiTranslationPromptConfigurationV1.getElementTag();
    return RET_VAL;
  }
