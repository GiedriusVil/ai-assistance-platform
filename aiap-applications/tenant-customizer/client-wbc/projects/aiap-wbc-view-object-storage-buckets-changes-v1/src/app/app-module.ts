...
import {
  ObjectStorageBucketsChangesTableV1,
...
import { WbcViewObjectStorageBucketsChangesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewObjectStorageBucketsChangesV1,
    // view
    ObjectStorageBucketsChangesViewV1,
    // components
    ObjectStorageBucketsChangesTableV1,
  ...
  entryComponents: [WbcViewObjectStorageBucketsChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewObjectStorageBucketsChangesV1,
      {
        injector: this.injector,
      });

    customElements.define(WbcViewObjectStorageBucketsChangesV1.getElementTag(), ELEMENT);
  }
}
