...
const HTML_TAG = 'aiap-wbc-view-object-storage-buckets-changes-v1';

@Component({
  selector: 'aiap-wbc-view-object-storage-buckets-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewObjectStorageBucketsChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewObjectStorageBucketsChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewObjectStorageBucketsChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewObjectStorageBucketsChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewObjectStorageBucketsChangesV1.getElementTag();
    return RET_VAL;
  }
