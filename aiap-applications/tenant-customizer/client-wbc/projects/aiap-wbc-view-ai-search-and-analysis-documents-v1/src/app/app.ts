...
const HTML_TAG = 'aiap-wbc-view-ai-search-and-analysis-documents-v1';

@Component({
  selector: 'aiap-wbc-view-ai-search-and-analysis-documents-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAiSearchAndAnalysisDocumentsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAiSearchAndAnalysisDocumentsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAiSearchAndAnalysisDocumentsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      ...
      _errorW(WbcViewAiSearchAndAnalysisDocumentsV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAiSearchAndAnalysisDocumentsV1.getElementTag();
    return RET_VAL;
  }
