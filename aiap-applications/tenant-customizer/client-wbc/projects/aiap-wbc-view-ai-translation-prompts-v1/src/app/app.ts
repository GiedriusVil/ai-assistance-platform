...
const HTML_TAG = 'aiap-wbc-view-ai-translation-prompts-v1';

@Component({
  selector: 'aiap-wbc-view-ai-translation-prompts-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewAiTranslationPromptsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewAiTranslationPromptsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewAiTranslationPromptsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewAiTranslationPromptsV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewAiTranslationPromptsV1.getElementTag();
    return RET_VAL;
  }
