...
import {
  ...
  AiTranslationPromptsTableV1,
  AiTranslationPromptsWatsonxContentV1,
} from './components';
...
import { AiapWbcViewAiTranslationPromptsV1 } from './app';

@NgModule({
  declarations: [
    AiapWbcViewAiTranslationPromptsV1,
    // view
    AiTranslationPromptsViewV1,
    // components
    AiTranslationPromptDeleteModalV1,
  ...
  entryComponents: [AiapWbcViewAiTranslationPromptsV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewAiTranslationPromptsV1, { injector: this.injector });
    customElements.define(AiapWbcViewAiTranslationPromptsV1.getElementTag(), ELEMENT);
  }
}
