...
const HTML_TAG = 'aiap-wbc-view-audio-voice-services-v1';

@Component({
  selector: 'aiap-wbc-view-audio-voice-services-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewAudioVoiceServicesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewAudioVoiceServicesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewAudioVoiceServicesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewAudioVoiceServicesV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewAudioVoiceServicesV1.getElementTag();
    return RET_VAL;
  }
