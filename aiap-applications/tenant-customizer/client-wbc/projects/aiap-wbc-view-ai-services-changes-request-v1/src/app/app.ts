...
const HTML_TAG = 'aiap-wbc-view-ai-services-changes-request-v1';

@Component({
  selector: 'aiap-wbc-view-ai-services-changes-request-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class AiapWbcViewAiServicesChangesRequestV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `AiapWbcViewAiServicesChangesRequestV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(AiapWbcViewAiServicesChangesRequestV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(AiapWbcViewAiServicesChangesRequestV1.getClassName(), 'ngOnChanges', { wbc });
      throw error;
    }
  }
  ...
  protected elCSSLinkId() {
    const RET_VAL = AiapWbcViewAiServicesChangesRequestV1.getElementTag();
    return RET_VAL;
  }
