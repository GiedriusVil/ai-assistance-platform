...
const HTML_TAG = 'aiap-wbc-view-ai-translation-services-changes-v1';

@Component({
  selector: 'aiap-wbc-view-ai-translation-services-changes-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAiTranslationServicesChangesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAiTranslationServicesChangesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAiTranslationServicesChangesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewAiTranslationServicesChangesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
      throw error;
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAiTranslationServicesChangesV1.getElementTag();
    return RET_VAL;
  }
