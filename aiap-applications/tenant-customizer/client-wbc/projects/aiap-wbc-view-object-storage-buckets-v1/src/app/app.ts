...
const HTML_TAG = 'aiap-wbc-view-object-storage-buckets-v1';

@Component({
  selector: 'aiap-wbc-view-object-storage-buckets-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewObjectStorageBucketsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewObjectStorageBucketsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewObjectStorageBucketsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewObjectStorageBucketsV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewObjectStorageBucketsV1.getElementTag();
    return RET_VAL;
  }
