...
import { WbcViewObjectStorageBucketsV1 } from './app';

@NgModule({
  declarations: [
    WbcViewObjectStorageBucketsV1,
    // view
    ObjectStorageBucketsViewV1,
    // components
    ObjectStorageBucketSaveModalV1,
  ...
  entryComponents: [WbcViewObjectStorageBucketsV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewObjectStorageBucketsV1,
      {
        injector: this.injector,
      });

    customElements.define(WbcViewObjectStorageBucketsV1.getElementTag(), ELEMENT);
  }
}
