...
import { AiapWbcViewAiServicesChangesV1 } from './app';

@NgModule({
  declarations: [
    AiapWbcViewAiServicesChangesV1,
    // view
    AiServicesChangesViewV1,
    // components
    AiServiceChangeViewV1,
  ...
  entryComponents: [AiapWbcViewAiServicesChangesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(AiapWbcViewAiServicesChangesV1, { injector: this.injector });
    customElements.define(AiapWbcViewAiServicesChangesV1.getElementTag(), ELEMENT);
  }
}
