...
const HTML_TAG = 'aiap-wbc-view-ai-search-and-analysis-projects-v1';

@Component({
  selector: 'aiap-wbc-view-ai-search-and-analysis-projects-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewAiSearchAndAnalysisProjectsV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewAiSearchAndAnalysisProjectsV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewAiSearchAndAnalysisProjectsV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      ...
      _errorW(WbcViewAiSearchAndAnalysisProjectsV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewAiSearchAndAnalysisProjectsV1.getElementTag();
    return RET_VAL;
  }
