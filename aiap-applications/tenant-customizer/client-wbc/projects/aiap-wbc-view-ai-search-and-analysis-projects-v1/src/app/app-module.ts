...
import {
  ...
  AiSearchAndAnalysisProjectsTableV1,
} from './components';

import { RoutingModule } from './modules/routing.module';
import { CarbonFrameworkModule } from './modules/carbon-framework.module';
import { WbcViewAiSearchAndAnalysisProjectsV1 } from './app';

@NgModule({
  declarations: [
    WbcViewAiSearchAndAnalysisProjectsV1,
    // view
    AiSearchAndAnalysisProjectsViewV1,
    // components
    AiSearchAndAnalysisProjectDeleteModalV1,
  ...
  entryComponents: [WbcViewAiSearchAndAnalysisProjectsV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewAiSearchAndAnalysisProjectsV1,
      {
        injector: this.injector,
      });
    customElements.define(WbcViewAiSearchAndAnalysisProjectsV1.getElementTag(), ELEMENT);
  }
}
