...
const HTML_TAG = 'aiap-wbc-view-jobs-and-queues-view-v1';
...
export class WbcViewJobsAndQueuesViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewJobsAndQueuesViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewJobsAndQueuesViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      ...
      _errorW(WbcViewJobsAndQueuesViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewJobsAndQueuesViewV1.getElementTag();
    return RET_VAL;
  }
