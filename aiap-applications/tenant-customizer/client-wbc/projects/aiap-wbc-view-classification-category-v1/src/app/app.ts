...
const HTML_TAG = 'aiap-wbc-view-classification-category-v1';

@Component({
  selector: 'aiap-wbc-view-classification-category-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})

export class WbcClassificationCategoryViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcClassificationCategoryViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcClassificationCategoryViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcClassificationCategoryViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcClassificationCategoryViewV1.getElementTag();
    return RET_VAL;
  }
