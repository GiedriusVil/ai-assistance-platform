...
import { WbcViewObjectStorageFilesV1 } from './app';

@NgModule({
  declarations: [
    WbcViewObjectStorageFilesV1,
    // view
    ObjectStorageFilesViewV1,
    // components
    ObjectStorageFileSaveModalV1,
  ...
  entryComponents: [WbcViewObjectStorageFilesV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcViewObjectStorageFilesV1,
      {
        injector: this.injector,
      });

    customElements.define(WbcViewObjectStorageFilesV1.getElementTag(), ELEMENT);
  }
}
