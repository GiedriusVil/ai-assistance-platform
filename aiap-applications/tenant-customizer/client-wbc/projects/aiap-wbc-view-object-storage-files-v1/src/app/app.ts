...
const HTML_TAG = 'aiap-wbc-view-object-storage-files-v1';

@Component({
  selector: 'aiap-wbc-view-object-storage-files-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcViewObjectStorageFilesV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcViewObjectStorageFilesV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcViewObjectStorageFilesV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcViewObjectStorageFilesV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcViewObjectStorageFilesV1.getElementTag();
    return RET_VAL;
  }
