...
const HTML_TAG = 'aiap-wbc-view-answer-stores-v1';

@Component({
  selector: 'aiap-wbc-view-answer-stores-v1',
  templateUrl: './app.html',
  styleUrls: ['./app.scss'],
})
export class WbcAnswerStoresViewV1 extends BaseAppWbcViewV1 implements OnInit, OnChanges {

  static getClassName() {
    return `WbcAnswerStoresViewV1`;
  }
  ...
  async ngOnChanges(changes: SimpleChanges) {
    ...
    try {
      ...
      _debugW(WbcAnswerStoresViewV1.getClassName(), 'ngOnChanges',
        {
          changes,
        });
      if (
      ...
      _errorW(WbcAnswerStoresViewV1.getClassName(), 'ngOnChanges',
        {
          wbc,
        });
  ...
  protected elCSSLinkId() {
    const RET_VAL = WbcAnswerStoresViewV1.getElementTag();
    return RET_VAL;
  }
