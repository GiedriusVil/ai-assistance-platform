...
import { WbcAnswerStoresViewV1 } from './app';

@NgModule({
  declarations: [
    WbcAnswerStoresViewV1,
    // view
    AnswerStoresViewV1,
    // components
    AnswerStoresDeleteModalV1,
  ...
  entryComponents: [WbcAnswerStoresViewV1]
})
export class AppModule implements DoBootstrap {
  ...
  ngDoBootstrap() {
    const ELEMENT = createCustomElement(WbcAnswerStoresViewV1,
      {
        injector: this.injector,
      });
    customElements.define(WbcAnswerStoresViewV1.getElementTag(), ELEMENT);
  }
}
