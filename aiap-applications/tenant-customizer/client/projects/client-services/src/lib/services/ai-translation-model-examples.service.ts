...
@Injectable()
export class AiTranslationModelExamplesService extends BaseServiceV1 {

  static getClassName() {
    return 'AiTranslationModelExamplesService';
  }
  ...
  findManyByQuery(query: any) {
    ...
    _debugX(AiTranslationModelExamplesService.getClassName(), 'findManyByQuery', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
  ...
  saveOne(aiTranslationModelExample: any) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiTranslationModelExamplesService.getClassName(), 'saveOne', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
  ...
  saveMany(aiTranslationModelExamples: any[]) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiTranslationModelExamplesService.getClassName(), 'saveMany', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
  ...
  deleteManyByIds(ids: Array<any>) {
    ...
    const REQUEST = { ids };
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiTranslationModelExamplesService.getClassName(), 'deleteManyByIds', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
  ...
  exportMany(query: any) {
    ...
    _debugX(AiTranslationModelExamplesService.getClassName(), 'exportMany', { REQUEST_URL });
  ...
  importManyFromFile(file: File, params: any) {
    ...
    const REQUEST_OPTIONS = this._requestOptions();
    _debugX(AiTranslationModelExamplesService.getClassName(), 'importManyFromFile', { REQUEST_URL, REQUEST, REQUEST_OPTIONS });
    const RET_VAL = this.http.post(REQUEST_URL, REQUEST, REQUEST_OPTIONS);
