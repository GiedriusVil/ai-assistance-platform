...
@Injectable()
export class DataMaskingConfigurationsService extends BaseServiceV1 {

  static getClassName() {
    return 'DataMaskingConfigurationsService';
  }
  ...
  findManyByQuery(query: any) {
    ...
    _debugX(DataMaskingConfigurationsService.getClassName(), 'findManyByQuery', { REQUEST_URL, REQUEST });
  ...
  saveOne(configuration: any) {
    ...
    _debugX(DataMaskingConfigurationsService.getClassName(), 'saveOne', { REQUEST_URL, REQUEST });
    return this.httpClient.post(REQUEST_URL, REQUEST, this.getAuthHeaders());
  }
  ...
  deleteManyByKeys(keys: Array<any>) {
    ...
    const REQUEST = { keys };
    _debugX(DataMaskingConfigurationsService.getClassName(), 'deleteManyByKeys', { REQUEST_URL, REQUEST });
    return this.httpClient.post(REQUEST_URL, REQUEST, this.getAuthHeaders());
  }
  ...
  findOneByKey(configKey: any) {
    ...
    _debugX(DataMaskingConfigurationsService.getClassName(), 'findOneByKey', { REQUEST_URL, REQUEST });
  ...
  exportMany(query: any) {
    ...
    _debugX(DataMaskingConfigurationsService.getClassName(), 'exportMany', { REQUEST_URL });
  ...
  importFromFile(file: File) {
    ...
    _debugX(DataMaskingConfigurationsService.getClassName(), 'importFromFile', { REQUEST_URL, REQUEST });
    const RET_VAL = this.httpClient.post(REQUEST_URL, REQUEST, this.getAuthHeaders());
    return RET_VAL;
  }
}
