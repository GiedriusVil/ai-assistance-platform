...
import { getMongoClients } from '../services/SurgeonService';
...
const MongoClientsView = () => {
  const [mongoClients, setMongoClients] = useState<DataTableRow[]>([]);

  useEffect(() => {
    const getData = async () => {
      const CLIENTS = await getMongoClients();
...
export default MongoClientsView;
