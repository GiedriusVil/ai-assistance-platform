...
import { getRedisClients } from '../services/SurgeonService';
      ...
      const ROWS: DataTableRow[] = Object.entries(CLIENTS).map(
        ([id, client]: [string, any]) => {
          const RET_VAL = {
            ...
            status: client?.status?.code ?? 'Unknown'
          };
          return RET_VAL;
        }
      )
...
export default RedisClientsView;
