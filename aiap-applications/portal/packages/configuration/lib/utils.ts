...
import { SecretProvidersConfig } from './types';

const getSecretProvider = async (rawConfig: any) => {
  const CONFIG: SecretProvidersConfig = {
...
const isStringTrue = (myValue: string) => (myValue === 'true');
