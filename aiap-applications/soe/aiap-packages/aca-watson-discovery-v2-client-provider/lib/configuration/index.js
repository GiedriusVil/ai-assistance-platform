...
*/
const MODULE_ID = 'aca-watson-discovery-v2-client-provider-configuration';
...
const { WA_DISCOVERY_V2_PROVIDER_SCHEMA } = require('./schema');
const { transformRawConfiguration } = require('./transformer');

class Configurator {

    static NAME = 'watsonDiscoveryClientsProvider';
    ...
    static schema() {
        const RET_VAL = {
            [Configurator.NAME]: WA_DISCOVERY_V2_PROVIDER_SCHEMA,
        }
        return RET_VAL;
    }
