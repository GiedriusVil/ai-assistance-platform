...
*/
const MODULE_ID = 'aiap-chat-channel-tealia-ace-provider-controllers-chat-v1-handle-request-queue';
...
const handleRequestQueue = async (
  ...
  try {
    ...
    logger.error(handleRequestQueue.name, { ACA_ERROR });
  ...
  if (
    ...
    logger.error(handleRequestQueue.name, { errors: ERRORS });
