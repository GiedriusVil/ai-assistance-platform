...
*/
const MODULE_ID = 'aiap-chat-channel-tealia-ace-provider-controllers-chat-v1-handle-request-established';
...
const handleRequestEstablished = async (
  request: any,
  response: any,
) => {
  ...
  try {
    ...
    logger.error(handleRequestEstablished.name, { ACA_ERROR });
  ...
  if (
    ...
    logger.error(handleRequestEstablished.name, { errors: ERRORS });
