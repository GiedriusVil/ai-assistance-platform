...
*/
const MODULE_ID = 'aiap-chat-channel-tealia-ace-provider-controllers-chat-v1-handle-request-finished';
...
const handleRequestFinished = async (
  ...
  try {
    ...
    logger.error(handleRequestFinished.name, { ACA_ERROR });
  ...
  if (
    ...
    logger.error(handleRequestFinished.name, { errors: ERRORS });
