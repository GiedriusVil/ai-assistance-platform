...
*/
const MODULE_ID = 'aiap-chat-channel-genesys-coh-provider-process-agent-joined-message';
...
const NOTIFICATION = {
  en: ' service advisor has joined the chat.',
  fi: ' palveluneuvoja liittyi keskusteluun.',
  sv: ' servicerådgivaren har anslutit sig till chatten.',
}

const processAgentJoinedMessage = async (
  ...
  try {
    ...
    logger.error(processAgentJoinedMessage.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}

export {
  processAgentJoinedMessage
}
