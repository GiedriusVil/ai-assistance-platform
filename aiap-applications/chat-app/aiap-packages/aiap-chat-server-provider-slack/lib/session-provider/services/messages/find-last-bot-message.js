...
*/
const MODULE_ID = 'aca-adapter-slack-services-messages-find-last-bot-message';
...
const findLastBotMessage = async (params) => {
  try {
    ...
    const CONVERSATION_ID = ramda.path(['conversation', 'id'], params);
