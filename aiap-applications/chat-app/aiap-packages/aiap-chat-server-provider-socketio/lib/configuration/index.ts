...
*/
const MODULE_ID = 'aiap-chat-server-provider-socketio-configuration-index';
...
const setConfigurationProvider = (provider) => {
  if (
    ...
    const ERROR_MESSAGE = 'Configuration provider is missing! [aca-common-config || aca-lite-config]';
...
class Configurator {
  ...
  static NAME = 'chatServerProviderSocketio';
