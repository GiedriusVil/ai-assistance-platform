...
*/
const MODULE_ID = 'aca-chat-server-session-provider-processor-outgoing-message-process-default-by-attachment-aca-error';
...
const processDefaultByAttachmentAcaError = async (context, params) => {
  ...
  try {
    ...
    logger.error(processDefaultByAttachmentAcaError.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
