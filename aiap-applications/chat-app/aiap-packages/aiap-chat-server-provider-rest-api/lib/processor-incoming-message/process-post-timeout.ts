...
*/
const MODULE_ID = 'aca-chat-server-session-provider-processor-incoming-message-process-post-timeout';
...
const processPostResponseTimeout = async (
  ...
  try {
    ...
    logger.error(processPostResponseTimeout.name, { ACA_ERROR });
    throw ACA_ERROR;
  }
}
