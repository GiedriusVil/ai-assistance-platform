...
*/
const MODULE_ID = `aiap-chat-app-configuration-external-configuration`;
...
const EXTERNAL_LIBRARIES_LIST = [
  ...
  '@ibm-aiap/aiap-chat-channel-genesys-coh-provider',
  '@ibm-aiap/aiap-chat-channel-telia-ace-provider',
  '@ibm-aiap/aiap-chat-channel-rocketchat-provider',
  ...
  '@ibm-aca/aca-socket-io-provider',
  '@ibm-aiap/aiap-main-event-stream-handler',
  '@ibm-aiap/aiap-tenants-resources-loader',
  '@ibm-aca/aca-lambda-modules-executor',
  '@ibm-aiap/aiap-chat-server-provider-socketio',
  '@ibm-aiap/aiap-chat-server-provider-slack',
  '@ibm-aiap/aiap-chat-server-provider-rest-api',
  '@ibm-aiap/aiap-tenant-event-stream-handler',
  '@ibm-aca/aca-jobs-queue-board-provider',
  '@ibm-aca/aca-chat-app-demo-express-routes',
  '@ibm-aca/aca-ibm-box-connector-express-routes',
...
const loadExternalLibsConfiguration = async (rootConfiguration, rawConfiguration, configurationProvider) => {
  try {
    ...
    const hostPage = require('./host-page-info');

    hostPage.AcaHostPageInfoConfigurator.loadConfiguration(rootConfiguration, rawConfiguration, configurationProvider);
    PROMISES.push(hostPage.AcaHostPageInfoConfigurator.loadConfiguration(rootConfiguration, rawConfiguration, configurationProvider));
