...
watch_client_shared_utils() {
  ng build aca-client-shared-utils --watch
}

watch_client_shared_services() {
  wait-on -l "../../../aiap-packages-shared-angular/dist/aca-client-shared-utils/public-api.d.ts" && ng build aca-client-shared-services --watch
}

watch_client_shared_components() {
  wait-on -l "../../../aiap-packages-shared-angular/dist/aca-client-shared-services/public-api.d.ts" && ng build aca-client-shared-components --watch
}

watch_client_shared_views() {
  wait-on -l "../../../aiap-packages-shared-angular/dist/aca-client-shared-components/public-api.d.ts" && ng build aca-client-shared-views --watch
}

watch_client_shared() {
  wait-on -l "../../../aiap-packages-shared-angular/dist/aca-client-shared-views/public-api.d.ts" && ng build aca-client-shared --watch
}
