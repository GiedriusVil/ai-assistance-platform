...
# set -x
# ------------------
# This script checks the security scanning result of the built docker image
# ------------------
# copy the script below into your app code repo (e.g. ./bin/check_vulnerabilities.sh) and 'source' it from your pipeline job
#    source ./bin/check_vulnerabilities.sh
# ------------------
# Properties file:
